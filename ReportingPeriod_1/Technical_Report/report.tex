...
all potential risks were assessed by the Coordinator. The risk
concerning the recruitment of highly qualified staff has been globally
well managed thanks to a flexible workplan enabling adjustments in the
timing of some tasks or deliverables, and thanks to legal actions
taken by the Coordinator to allow key personnel, permanent or not, to
remain in the Consortium even though their positions changed. The
addition of the three partners is representative of these actions.
...
%Explain, task per task, the work carried out in WP during the reporting period giving details of the work carried out by each beneficiary involved.
  ...
  \delivref{component-architecture}{portability-cygwin} by producing a
  ...
  \TODO{Mention that, after months of work, the latest version of Sage
    (with some additional patches) actually compiles and run in
    Cygwin, and a beta version of the installer has been released in
    December}
  ...
  \TODO{Refer to the related work on identifying best practices for
    C-level interfaces in the cypari task}
  ...
  Anaconda\TODO{or Conda?}. We stress the fact that this task is very much ahead of
  ...
  featured VRE.  Because of the tight, partly closed source\TODO{do we
    want to mention the closed source aspect? at this stage there is
    not much, if anything, closed source, and this has not gotten in our way
    when investigating, right?}
  ...
  because of the slow recruitment process in \site{PS}. We were able
...
%Explain, task per task, the work carried out in WP during the reporting period giving details of the work carried out by each beneficiary involved.
  ...
  \taskref{social-aspects}{social-input} and
  \taskref{social-aspects}{isocial-decisionmaking} whose early outcomes will nurture
  the design of \ODK's VREs in other work packages. As well, good progress was booked
  on  \taskref{social-aspects}{social-output}.

  \paragraph{\longtaskref{social-aspects}{social-input}} % T1
  For deliverable \longdelivref{social-aspects}{social-datareport},
  ...
  Part I of \longdelivref{social-aspects}{social-report-three} is also ready and available
  as an internal publication.

  \paragraph{\longtaskref{social-aspects}{social-output}} % T2
  ...
  \paragraph{\longtaskref{social-aspects}{isocial-decisionmaking}} % T3
  Deliverable \longdelivref{social-aspects}{social-tracaddon}
  is largely ready and is to be tested on the
  system \Sage; a paper \cite{Pavlou:2016:MCI:2936924.2936934}, forming a part of
  \longdelivref{social-aspects}{social-gametheoretic} has been published.

  \paragraph{\longtaskref{social-aspects}{oommf-nb-evaluation}} % T4
  Not applicable for this period.
