...
\item Several algorithmic innovations have been produced: more efficient
  representation for quasiseparable matrices~\cite{Per16}, and the new developments on
  interactive certificates for the security of large scale distributed
  computations on unsafe resources~\cite{DKV16,DLP17}. Both results have or will be presented at the
  main conference in the field, ISSAC'16 and ISSAC'17.
\end{itemize}
