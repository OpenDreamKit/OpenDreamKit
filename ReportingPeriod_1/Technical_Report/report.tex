...
\def\deliv@management@periodic@title{Periodic Management Reprot I (18 Months)}
\def\deliv@management@periodic@lead{Nicolas Thierry}
\def\deliv@management@periodic@issue{ISSUE}
\makeatother
