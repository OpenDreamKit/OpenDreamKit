...
%Explain, task per task, the work carried out in WP during the reporting period giving details of the work carried out by each beneficiary involved.
  ...
  packaging index under the name \texttt{oommfc}. We have published a
  corresponding paper (\href{http://dx.doi.org/10.1063/1.4977225}{http://dx.do
  i.org/10.1063/1.4977225}). The interface has been presented to users in the
...
% \paragraph{\longtaskref{UI}{Sage-display}} % M24, no delkiverables
