...
\item \label{objective:community} ``To bring together research
  ...
  \item Sharing best practice for packaging and building
    containers;
  ...
  \item Sharing best practice when using VRE's like \SMC or \Jupyter
...
%Explain, task per task, the work carried out in WP during the reporting period giving details of the work carried out by each beneficiary involved.
  ...
  In this task we investigate best practice for composing, sharing
...
\begin{itemize}
\paragraph{cloud.sagemath.org} With 500k accounts worldwide and 30k active
...
\paragraph{jupyter.math.cnrs.fr} We have helped setup this \JupyterHub
...
\paragraph{mybinder.org} Binder is a web service that makes it easy for any
