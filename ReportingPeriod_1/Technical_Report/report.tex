...
Mathematical software, such as \Sagemath, intensively rely on the Python
...
programming style of \SageMath. Deliverable \delivref{hpc}{pythran-typing}
...
Further work on \Pythran's intgeration to \SageMath and the exposition of
parallelism via \Cilk++ is still in progress and should be delivered in
