...
\TODO{Try to include the following suggestions by Wolfram:
  \begin{itemize}
...
\TODO{Improve the examples? Something from health care depending on
  pure maths?}  Improvements of the economy, ecology, health care and
society overall are driven though innovation. The key enabling tool
for innovation advances is mathematical knowledge and
...
innovation that enrich society and mankind are made possible through
mathematical foundations, often developed long before their potential
applications.

% recent developments
Modern mathematical research is increasingly accelerated by and
enabled through, e.g., collaborative tools, computational
environments, and online databases. These tools have the potential to
...
We will achieve this by focusing on a \emph{toolkit of software
  ...
  flexibly} to cater for the diversity and evolutivity of needs in maths, science and
...
open source code developers.% working on the same codebase.
Simultaneously the last decade witnessed the emergence of
fundamental open source building blocks, at the forefront of which
computational components like \Sage or the interactive computing
environments like \Jupyter.
% Litterate computing? Executable documents. 
%
...
\TODO{This first sentence is a bit specific to scientific computing}
...
paving the way towards faster commercialisation \TODO{anything better?
  it's about putting to practical use, commercially, or not} of basic
research.
