...
The basic unit thereof are executable documents that consist of a
number of executable cells which contain code, that can be
interactively executed, and the output of the code.
