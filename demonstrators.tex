...
%\includegraphics[width=0.5\textwidth]{Pictures/micromagnetic-and-3d-vis.pdf}
%\caption{A selection of typical visualisation patterns often required in science and engineering: a 3d vector field on a 2d domain, }
%\end{wrapfigure}
%
