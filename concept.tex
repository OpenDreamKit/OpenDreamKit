...
\subsubsection{Mathematics is at the heart of innovation}
...
\subsubsection{Impact of the digital world for research in pure
  mathematics and applications}

\paragraph{Exploration tools are crucial for research in pure mathematics}
...
\paragraph{Collaborative tools are having deep effects on how
...
\paragraph{Collaboration on Mathematical Software, Data, Knowledge}
...
\subsubsection{Virtual Research Environments for Mathematics}
...
\subsubsection{The diversity of needs}
...
\subsubsection{Development models for mathematical software: a
...
\subsubsection{Benefits of focusing on a toolkit?}

\paragraph{Meeting actual needs in Mathematics}
...
\TODO{Better explain the specific needs in maths, and the necessity
  ...
  user stories: VREs used by researchers in mathematics, but also used
  by engineers for instance as a tool, or by students sometimes. 
  So VREs needed w different level of complexity.
  Also: data and software in math not really patentable, no big money.
  No real ownership fights. 
  Some VREs need to support search, other computations. 
}
