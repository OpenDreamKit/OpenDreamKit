...
projects in mathematics and its applications.
\end{boxedminipage}
\end{center}
...
many of those innovations. Examples abound. The global
...
<obile phone connectivity depends on combinatorial optimization
...
algorithms. These developments have been made possible by investments
into pure and applied research in mathematics over many decades giving
rise to mathematical insights that serve as the foundation for eengineering and
business innovation that enriches
society.
...
underpinned by mathematical models of concurrency, while many 
now standard programming paradigms (iterators,
comprehensions, generics) appeared first in computer algebra systems. \TODO{evidence}


\paragraph{Impact of the digital world on mathematical research}

\subparagraph{Exploration tools are crucial for research in pure mathematics}

From their early days, electronic computers have been used in pure
mathematics, either to prove theorems (famously the four color
theorem) or, like the telescope for astronomers, to explore in search
of new theories.  Computer aided experiments are now part of the
standard toolbox of the pure mathematician, and certain areas of
mathematics completely depend on it.
...
Birch and Swinnerton-Dyer conjecture -- one of the Clay Millenium
Problems and a starting point for the lines of enquiry that led to
Wiles proof of Fermat's last theorem.  Databases developed and accessed by
computer calculations such as the Small Groups Library or the Atlas of
Modular Character Tables (in group and representation theory) are indispensable tools.

The introduction of computers has also motivated the search for
constructive versions of proofs of deep
theorems, that yield algorithmic tools to deal with highly abstract
...
M%% % numerical computations (e.g., by Mestre).
...
%% which previously were inconcei vable.
...
``we'' discovered, rather than assign credit to individuals. An
extreme case is the famous footnote ``since completing this work, one
of us has died''.
...
day-to-day basis was traditionally asolitary pen-and-paper activity of
...
Email was the first step in this direction, allowing correspndence in
...
Many mathematical databases now exist, some very large, but their
...
\subparagraph{Computational mathematicals is interdisciplinary by nature}
...
Mathematical research projects and teams that make use of
...
\paragraph{First benefit: learning to meet actual needs in Mathematics}
...
In this section we describe how we will realize this concept, and why
...
systems.  \TheProject will be designed to benefit from future open
...
greatly amplified by these factors.
...
impacts, promotion of innovation; (tasks
\ref{dissemination-communication}, \ref{dissemination}) 
...
involvement of industrial associations in consortia or in advisory bodies;(tasks
\ref{dissemination-communication}, \ref{dissemination}, \ref{project-intro}) 
\item strengthening of virtual research communities; (tasks
  \ref{devel-workshops},\ref{dissemination})
\item spreading of good practices, consultancy and training courses to
  new users; (tasks \ref{project-intro},
  \ref{dissemination-of-oommf-nb-workshops})
\item exchange of personnel and training of staff (task \ref{devel-workshops});
\end{itemize}
...
software; (WPs \ref{user-interfaces}, \ref{hpc})
\item integration of installations and infrastructures into virtual
  facilities; (WPs \ref{component-architecture}, \ref{social-aspects})
\item innovative solutions for data collection, management, curation
  and annotation; (WP \ref{dks-bases})
\end{itemize}
...
The joint research activities are defined by our vision for
\TheProject. WP \ref{component-architecture} essentially defines the
requirements for a component to be part of the kit, WP
\ref{user-interfaces}, WP \ref{hpc} and WP \ref{dks-bases} address
limitations of current components, or areas where they have become out
of date and WP \ref{social-aspects} is key to our goal to produce
...
\ref{component-architecture}, \ref{dks-bases} and \ref{hpc}. Our
architecture will include interfaces to standard APIs for cloud
provisioning, authentication, cloud storage, HPC scheduling and so
forth. Actual VREs will be deployed by users integrating those with
specialist tools according to the needs of their projects. \COMMENT{weak}
...
applications. We will consult with the Head
  of Equality and Diversity at St Andrews, about any known gender differences in
collaborative working and ensure that our collaborative tools properly
support open, equitable and inclusive patterns of cooperation. This
will be reported in deliverable \ref{ipr}.
