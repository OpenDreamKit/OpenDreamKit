...
\item \textbf{Data Repositories/Communities}: Many communities have been collecting and
  sharing data about the obejcts they study: e.g.
  \begin{compactenum}[a.]
  \item The \emph{Open Encyclopedia of Integer Sequences} [\url{http://oeis.org}] has
    ...
    steadily growing
  \item The \emph{data base L-Functions, Modular Forms, and related objects}\TODO{@PD,
      please complete}
  \item \TODO{one more}
  \end{compactenum}
\item \textbf{Knowledge Sources and Repositories} There are many ways to represent
  ...
  \item to mathematical encylopedias like [\url{http//planetmath.org}], which as a Web2.0
...
\item \textbf{Mathematical Software Development and Systems}
  \begin{compactenum}[a.]
  \item \TODO{Please add three interestinly different paradigmatic software systems here}
  \end{compactenum}
\end{enumerate}
