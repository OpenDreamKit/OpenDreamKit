...
\WPref{dissemination-communication}, \WPref{dissemination}) 
\item reinforcing partnership with industry: outreach and dissemination activities,
  transfer of knowledge, activities to foster the use of e-infrastructures by industrial
  researchers, involvement of industrial associations in consortia or in advisory bodies;
  (tasks \taskref{dissem}{dissemination-communication}, \taskref{dissem}{dissemination},
  \taskref{dissem}{project-intro})
...
\item spreading of good practices, consultancy and training courses to
  new users; (tasks \taskref{dissem}{project-intro},
  \taskref{dissem}{dissemination-of-oommf-nb-workshops})
\item exchange of personnel and training of staff (task
...
\item innovative solutions for data collection, management, curation and annotation;
  (\WPref{dksbases})
\end{itemize}
...
requirements for a component to be part of the kit, \WPref{user-interfaces}, \WPref{hpc}
and \WPref{dksbases} address limitations of current components, or areas where they have
