...
('merging'). This is particularly relevant for \href{\Jupyter
  notebooks}{http://jupyter.org}, which allow scientists to write and
share documents that mix live code, equations, visualizations and
explanatory text.
...
\begin{figure}
    \center
    \framebox{\includegraphics[width=.75\textwidth]{img/nbmerge}}
