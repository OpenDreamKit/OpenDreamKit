...
In the previous example, we only explored the exquation by instantiating the variables (we
...
\end{itemize}
Consider also the case of ``\emph{five gold dubloons}'' used by Adam Smith in an
intuition-building example in his seminal book ``Wealth of Nations'' from
...
``\emph{five gold dubloons}'' buy a simple meal, a fine riding horse or a mansion. Here,
