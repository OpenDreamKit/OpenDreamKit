...
In~\longdelivref{UI}{adstex}, we have proposed ``Active Structured Documents'' as a natural interface for interacting
...
%  LocalWords:  analyzes sec:infarch sec:concl sec:impl
