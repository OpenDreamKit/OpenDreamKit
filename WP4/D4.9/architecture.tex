...
\begin{lstlisting}[language=XML,morekeywords={constant,type,apply,math,ci,csymbol},basicstyle=\footnotesize\sf]
<constant name="eme">
 <type>
  <math>
   <apply><eq/>
...
combines the sysystem name \lstinline|eme| with the statement of the equation in the
