...
Our integrated VRE consists of four components: a Jupyter Notebook server\ednote{jupyter.mathhub.info}, a MathHub Git repository hosting server\ednote{gl.mathhub.info}, an MMT instance\ednote{mmt.mathhub.info}, and our new MathHub frontend\ednote{mathhub.info} that serves as the main entry point for users and delegates some subtasks to the former.
