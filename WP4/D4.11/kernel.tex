...
KA: why not add a screenshot for it right here?}
...
\ednote{KA: make pretty Diagramm to show what happens when e.g. buttons are clicked or user inputs a write-command}
