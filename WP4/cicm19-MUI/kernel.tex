...
\begin{minipage}[c]{10cm}\includegraphics[width=10cm]{../D4.11/test_theory_jupyter}\end{minipage}
\begin{minipage}[c]{5cm}\includegraphics[width=5cm]{../D4.11/test_theory}\end{minipage}
