...
\ednote{FR: this can be shortened if needed}
...
\ednote{@TW,KA: add examples for this workflow; this overlaps with later examples, so some later examples may be pulled forward}
