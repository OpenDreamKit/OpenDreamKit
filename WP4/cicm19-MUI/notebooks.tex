...
\ednote{@TW: I've removed the footnote about the implementation being partial. Make sure everything works as described.}

\ednote{@TW: I've added a few parts to the story and slightly restructured the text. Make sure everything we say is true.}
...
\end{figure}
\ednote{MK@KA: das sollte noch bedeutend schöner gemacht werden (und kleiner).}
...
\end{figure}
\ednote{MK@KA: besseres Noteobok.}
