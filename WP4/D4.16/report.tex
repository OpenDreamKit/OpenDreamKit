...
implemented by them, i.e. an API.

Currently hidden in the \emph{GridViewEditor} itself, we intend to
develop adapters for the Sage objects, either by implementing Adapter
classes, or by writing translating information. Here are a few code examples
