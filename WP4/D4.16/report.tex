...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=\textwidth]{images/ipyleaflet}
  ...
  %courtesy of the \lstinline{ipyleaflet} documentation).}
...
% OB : I guess I addressed this on line ~371 - subsection ``description of
% the design
