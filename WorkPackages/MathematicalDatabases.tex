...
\begin{task}[title={Formulation of requirements and design of new infrastructure when appropriate}, id=data-design]
  \TOWRITE{Michael/POD}{Rewrite database requirements design task}
...
\TODO{provide more info about above claim: ontologie not suitable because of
  extreme reification}

\TODO{Logilab suggests to organize workshop first, to confront different
