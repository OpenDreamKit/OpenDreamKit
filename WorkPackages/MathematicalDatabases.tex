...
\TOWRITE{MK}{Some bit went missing here before next paragraph. If example of LMFDB is to be kept, should mention Knowls as custom solution for active presentation of math knowledge}
