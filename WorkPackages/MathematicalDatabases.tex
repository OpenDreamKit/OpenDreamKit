...
\begin{workpackage}[id=dksbases,wphases=1-48!.5,
  ...
  ZHRM=12,JURM=36,USHRM=12,UWRM=25,SARM=10]
...
\begin{task}[id=data-design,lead=JU,partners={ZH,US,SA,UW},
  ...
  \TODO{original comment: provide more info about above claim: ontologies not suitable
    because of extreme reification}

  \TODO{original comment: Logilab suggests to organize workshop first, to confront
    different cultures before committing to the design of a new infrastructure. For
