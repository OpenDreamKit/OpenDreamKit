...
\begin{WPObjectives}
  ...
  references, citability, recomputation without copying entire
  database into VM.

  Participants: Warwick, Paul Oliver Dehaye, Logilab (SME in Paris)
\end{WPObjectives}
...
\item \ref{del:persistent_memoization} (Month X): Shared persistent
  ...
  e.g. Sage's cached_method, but across sessions.  They further want
  to share the underlying growing database between themselves, and
  maybe eventually publish it.
