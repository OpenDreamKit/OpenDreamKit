...
\begin{task}[id=data-design,lead=JU,partners={ZH,US,SA,UW,LL},wphases={6-12,15-18!.33},PM=12,
 ...
 \localdelivref{design}. Conversion issues are covered in \localdelivref{data-foundationCAS}.
\end{task}
...
\begin{task}[title=Memoization and production of new data,id=data-memo,
  ...
  \texttt{cached_method}. Neither offers storage is not persistent across sessions or
