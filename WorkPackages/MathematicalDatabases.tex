...
\begin{wpdescription}
  ...
  Work Packages \TODO{work package on interfaces, and???}, and would draw on previous work
...
\begin{task}[title=Survey of existing databases,id=data-assessment,
  ...
  data and projects to add to this e4bffort, aiming to maximise the impact of our work.
\end{task}
...
\begin{task}[id=data-design,lead=JU,partners={ZH,US,SA,UW},
  ...
  \TOWRITE{Michael/POD}{Rewrite database requirements design task -- done second pass,
    Michael have a look?}
  ...
  Drawing on semantic web/Linked Open Data experience of the Logilab group, specialised to
  ...
  \TODO{original comment: provide more info about above claim: ontologie not suitable
    because of extreme reification}

  \TODO{original comment: Logilab suggests to organize workshop first, to confront
    different cultures before comitting to the design of a new infrastructure. For
    example, based on its experience with CubicWeb, Logilab would promote the
    decentralized mechanism of the (semantic) web for publishing mathematical data,
...
\begin{task}[title=Memoization and production of new data,id=data-memo,
  ...
  propose to use, extend and contribute back to some established persistent memoization
