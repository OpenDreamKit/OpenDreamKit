...
(but no standardised format for formulae and references), so we expect to get 250 k
...
\begin{wpdelivs}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=15,miles=proto1,id=dksimp,dissem=PU,nature=OTHER,lead=JU]
        {Implementation of Triform Theories in the MMT API}
  \end{wpdeliv}
  \begin{wpdeliv}[due=18,miles=proto1,id=lmfmod,dissem=PU,nature=R,lead=ZH]
      {\LMFDB deep modelling: Fragment Identification \& Initial Model Design}
  \end{wpdeliv}
  \begin{wpdeliv}[due=20,miles=proto1,id=oeisparser,dissem=PU,nature=OTHER,lead=JU]
  ...
  \begin{wpdeliv}[due=24,miles=proto1,id=conv,dissem=PU,nature=DEC,lead=ZH]
   ...
   \end{wpdeliv}
  \begin{wpdeliv}[due=24,miles=proto1,id=psfoundation,dissem=PU,nature=OTHER,lead=JU]
...
\end{wpdeliv}
  ...
  \end{wpdeliv}
   \begin{wpdeliv}[id=cassearch,due=30,nature=OTHER,dissem=PU,lead=JU]
    ...
    \end{wpdeliv}
  \begin{wpdeliv}[due=36,miles=community,id=pssem,dissem=PU,nature=OTHER,lead=JU]
      {\Python/\Sage Declarative Semantics in OMDoc/MMT}
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,miles=community,id=lfmverif,dissem=PU,nature=OTHER,lead=JU]
  ...
  \end{wpdeliv}
\begin{wpdeliv}[id=nbad-search,miles=eval,due=42,nature=OTHER,dissem=PU,lead=JU]
...
\end{wpdeliv}
  \begin{wpdeliv}[due=48,miles=eval,id=lfmint,dissem=PU,nature=R,lead=JU]
