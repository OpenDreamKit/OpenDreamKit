...
\begin{task}[id=dissemination-of-oommf-nb-virtual-environment,
  title=Dissemination of \OOMMFNB{} virtual environment]
  ...
  regression tests (from \taskref{UI}{oommf-python-interface} and \taskref{UI}{id=oommf-py-ipython-attributes}) routinely when the
...
\begin{task}[title=\OOMMFNB{} dissemination workshops,
...
% \taskref{dissem}{dissemination-of-oommf-nb-workshops}\\
  ...
  meetings to disemminate the open source \OOMMFNB{} tool (see \taskref{UI}{oommf-python-interface} to
  \taskref{UI}{oommf-tutorial-and-documentation} and \localtaskref{dissemination-of-oommf-nb-virtual-environment}) in the
  ...
  multiple workshops can be given per conference, i.e. one workshop
...
\begin{wpdelivs}
 ...
 \begin{wpdeliv}[due=32,id=oommfnb-source-and-testing-setup,dissem=PU,nature=DEC]{\OOMMFNB{} public
     repository and
     continuous integration set up} \end{wpdeliv}
