...
\TODO{MK: I would combine the first three into one ``basic project intrastructure''}
\begin{wpdelivs}
\begin{wpdeliv}[due=1,id=tickets,dissem=??,nature=??]{Create tickets for all relevant tasks / deliverables}
\end{wpdeliv}
\begin{wpdeliv}[due=1,id=mailinglists,dissem=??,nature=??]{Internal and external mailing lists}
\end{wpdeliv}
\begin{wpdeliv}[due=1,id=swrepository,dissem=??,nature=??]{Internal software repository}
\end{wpdeliv}
\begin{wpdeliv}[due=12,id=periodic-rep-1,dissem=??,nature=??]{Project Periodic Report (first year)}
 \end{wpdeliv}
\begin{wpdeliv}[due=24,id=periodic-rep-2,dissem=??,nature=??]{Project Periodic Report (second year)}
 \end{wpdeliv}
\begin{wpdeliv}[due=36,id=periodic-rep-3,dissem=??,nature=??]{Project Periodic Report (third year)}
 \end{wpdeliv}
\begin{wpdeliv}[due=48,id=periodic-rep-4,dissem=??,nature=??]{Project Periodic Report (fourth year)}
 \end{wpdeliv}
\begin{wpdeliv}[due=48,id=final-mgt-rep,dissem=??,nature=??]{Project Final Report}
 \end{wpdeliv}
\end{wpdelivs}
\end{workpackage}
%%% Local Variables: 
