...
promote project results;
  ...
  \item Data and IPR Management will be managed in accordance with
    ...
    (\delivref{management}{data-plan1},\delivref{management}{data-plan2},\delivref{management}{data-plan3}).
  \end{compactitem}
\end{task}
