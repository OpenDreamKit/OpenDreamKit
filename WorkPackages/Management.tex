...
\begin{workpackage}[id=management,type=MGT,wphases=0-48!.2,swsites,
  ...
  lead=PS,
  PSRM=28,SARM=2,USORM=2,LLRM=2,UVRM=2,UJFRM=2,UBRM=2,UORM=2, USHRM=2, USORM=2, UWRM=2, JURM=2, UKRM=2, USRM=2, ZHRM=1, SRRM=2, UWSRM=2]
...
id=project-finance-management,lead=PS,PM=33,partners={PS,SA,USO,LL,UV,UJF,UB,UO,USH,USO,UW,JU,UK,US,ZH,SR,UWS}]
