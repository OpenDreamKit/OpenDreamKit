...
\item A joint event between \GAP, \Sage, and \Sigular in ICMS, Edinburgh.

\item A joint \Jupyter and \Sage event in Orsay.

\item A joint \LMFD and \Sage event in Warwick to work towards \WPref{dksbases}.
...
\begin{wpdelivs}
 ...
 \begin{wpdeliv}[due=42,id=oommfnb-workshops,dissem=PU,nature=O,lead=USO]{\OOMMFNB{}
