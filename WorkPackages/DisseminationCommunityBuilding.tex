...
\begin{task}[id=dissemination-of-oommf-nb-virtual-environment,
  ...
  \taskref{UI}{oommf-tutorial-and-documentation} provide a micromagnetic
  VRE demonstrator built on top of \TheProject. 
  In this task, we set up of the infrastructure (\delivref{dissem}{oommfnb-source-and-testing-setup}) to encourage and
