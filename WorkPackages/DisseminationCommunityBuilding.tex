...
\begin{workpackage}[id=dissem,wphases=1-48!.5,
...
\begin{task}[title=Dissemination and Communication activities, lead=PS, id=dissemination-communication, PM=1, partners={LL,UV,UJF,UB,UO,USH,USO,SA,UW,JU,UK,US,ZH,SR,UWS} ]
  ...
  moments (at least two). %, making use of the public relation support services in the respective institutions.
...
\begin{task}[title=Introduce \TheProject to Researchers and Teachers, id=project-intro,lead=USH,PM=20]
  ...
  Finally, our aim will be to introduce ideas from \WPref{social} in our teaching
  materials. By the end of the project we will have produced a series of interactive
  notebook demonstrators \localdelivref{notebook} of \TheProject with a particular focus
  on computational biology, data science and machine learning. These notebooks will expand
  the of VREs in these domains, appealing to researchers used to the domains of
  Bioconductor and MATLAB. We will make use of live notebook posters
  (\delivref{social}{social-poster}) and commenting systems
  (\delivref{social}{jupyter-comment}). These interactive notebooks will be provided in a
  public repository (\delivref{dissem}{notebook-repo}).
\end{task}
