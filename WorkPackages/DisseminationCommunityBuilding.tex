...
\begin{wpdescription}
  ...
  to organise cross communities workshops like Sage-Jupyter days.
  ...
  part of the project will be made available as open source. All publications
  will be made as open access.
...
\begin{wpdeliv}[due=24,id=ils-tool,dissem=PU,nature=P,lead=UV]{Community-curated
 ...
 \begin{wpdeliv}[due=24,id=ibook2,dissem=PU,nature=DEM,lead=US]{Demonstrator: Linear Algebra -  interactive book} \end{wpdeliv}
 \begin{wpdeliv}[due=24,id=ils-tool,dissem=PU,nature=P,lead=UV]{Community-curated
     indexing tool (open source)} \end{wpdeliv}
 \begin{wpdeliv}[due=24,id=ils-service,dissem=PU,nature=DEM,lead=UV]{Community-curated
     indexing service for \TheProject} \end{wpdeliv}
 ...
 \begin{wpdeliv}[due=47,id=ibook3c,dissem=PU,nature=DEM,lead=US]{Demonstrator: Problems in Physics with Sage v3} \end{wpdeliv}
