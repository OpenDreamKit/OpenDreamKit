...
id=ibook,lead=US,PM=30,wphases=0-36]
...
be a classical mathematical textbook natively desingned  within VRE.

The last example will focus mostly on collaborative editing and
modularity of content which is produced using VRE technologies. On the
other hand we will demonstrate power of CAS systems working ``on par''
with numerical tools in problem solving mainly in the field of
