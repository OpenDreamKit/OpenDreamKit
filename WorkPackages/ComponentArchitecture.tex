\begin{workpackage}[id=component-architecture,wphases=3-24!.5,
  ...
  \begin{task}[title=Interfaces between systems]
  ...
  \begin{task}[title=Modularization and packaging]
  ...
  \begin{task}[title=Deployment and distribution]
    \TODO{NT: what did you have in mind?}
  \end{task}

  \begin{task}[title=Component architecture for High Performance Computing and Parallelism]
