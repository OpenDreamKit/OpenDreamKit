...
\end{tasklist}
  ...
  \begin{wpdelivs}
    \begin{wpdeliv}[due=12,id=portability-cygwin32,dissem=PU=PU,nature=D]
    ...
    \begin{wpdeliv}[due=24,id=portability-cygwin64,dissem=PU=PU,nature=D]
    ...
    \begin{wpdeliv}[due=36,id=multiplatform-buildbot,dissem=PU=PP,nature=P]
    ...
    \end{wpdeliv}%
    \begin{wpdeliv}[due=24,id=scscp-sage,dissem=PU=PU,nature=D]
      {Support for the
    ...
    \begin{wpdeliv}[due=48,id=semantic-interface-sage-gap,dissem=PU=PU,nature=P]
      {Semantic-aware \Sage interface to \GAP.}
    \end{wpdeliv}
    \begin{wpdeliv}[due=12,id=virtual-machines,dissem=PU=PU,nature=O]
    ...
    % \end{itemize}}
    \begin{wpdeliv}[due=48,id=hpc-configure,dissem=PU,nature=P]
      {HPC enabled \Sage distribution}
    \end{wpdeliv}

    \begin{wpdeliv}[due=24,id=smc-trac,dissem=PU,nature=D]
