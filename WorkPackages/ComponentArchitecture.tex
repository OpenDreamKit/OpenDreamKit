\TOWRITE{HF}{Proofread WP 3 Component Architecture pass 1}
...
\begin{workpackage}[id=component-architecture,wphases=0-48!.5,
  ...
  \begin{tasklist}
  \begin{task}[id=portability,title=Portability,lead=UV,PM=28,partners={PS},wphases=1-36]
  ...
  \begin{task}[title=Interfaces between systems,id=interface-systems,lead=PS,PM=22,partners={UV,UO,USTAN},wphases=1-36]
  ...
  \begin{task}[title=Modularization and packaging,id=mod-packaging,lead=UV,PM=32,partners={PS,LL},wphases=1-48]
...
\begin{task}[id=simulagora-dev,title=Simulagora integration,PM=4,lead=LL,wphases=1-48]
...
\end{task}
  ...
  \begin{task}[title=Document and modularize \SMC's codebase,id=extract-smc,lead=PS,PM=10,partners={UV},wphases=1-24]
