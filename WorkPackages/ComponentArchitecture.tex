...
\end{tasklist}
  ...
  \begin{wpdelivs}
    \begin{wpdeliv}[due=12,id=portability-cygwin32,dissem=PU,nature=D]
    ...
    \begin{wpdeliv}[due=24,id=portability-cygwin64,dissem=PU,nature=D]
    ...
    \end{wpdeliv}%
    \begin{wpdeliv}[due=24,id=scscp-sage,dissem=PU,nature=D]
      {Support for the
    ...
    \begin{wpdeliv}[due=48,id=semantic-interface-sage-gap,dissem=PU,nature=P]
