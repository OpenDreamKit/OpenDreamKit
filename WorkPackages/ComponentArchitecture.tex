\begin{workpackage}[id=component-architecture,wphases=3-24!.5,
  ...
  \begin{wpdelivs}
    \begin{wpdeliv}[due=12,id=portability_cygwin32,dissem=PU,nature=D]
    ...
    \begin{wpdeliv}[due=24,id=portability_cygwin64,dissem=PU,nature=D]
    ...
    \begin{wpdeliv}[due=36,id=multiplatform_buildbot,dissem=PP,nature=P]
  ...
  \begin{wpdelivs}
    \begin{wpdeliv}[due=24,id=scscp_sage,dissem=PU,nature=D]
      {Support for the
        \href{http://www.symbolic-computing.org/}{SCSCP} interface
        protocol in all relevant components (\Sage, \GAP,
        etc.).}distribution
    \end{wpdeliv}

    \begin{wpdeliv}[due=48,id=semantic_interface_sage_gap,dissem=PU,nature=P]
  ...
  \begin{wpdelivs}
    \begin{wpdeliv}[due=12,id=virtual_machines,dissem=PU,nature=O]
    ...
    \begin{wpdeliv}[due=24,id=sage_modularization,dissem=PU,nature=O]
      ...
      code). This is a prerequisite for \delivref{sage_distribution}.
    \end{wpdeliv}

    \begin{wpdeliv}[due=48,id=sage_distribution,dissem=PU,nature=O]
  ...
  \begin{wpdelivs}
    \begin{wpdeliv}[due=48,id=hpc_configure,dissem=PU,nature=P]
  ...
  \begin{wpdelivs}
    \begin{wpdeliv}[due=24,id=smc_trac,dissem=PU,nature=D]
