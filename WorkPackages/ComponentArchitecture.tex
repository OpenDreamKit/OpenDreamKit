...
\TOWRITE{LL}{Please check your PM engagement (task simulagora-dev)}
...
\begin{workpackage}[id=component-architecture,wphases=0-48!.5,
  ...
  PSRM=64,UVRM=8,SARM=16, USHRM=4, USORM=6]
...
\begin{task}[id=simulagora-dev,title=Simulagora integration,PM=4,lead=LL]
  \TOWRITE{Logilab}{Decide to leave here or move to dissemination?}
