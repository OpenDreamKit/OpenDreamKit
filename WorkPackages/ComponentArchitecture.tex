...
\end{tasklist}
  ...
  \begin{wpdelivs}
    \begin{wpdeliv}[due=12,id=del:portability_cygwin32,dissem=??,nature=??]
...
\end{wpdeliv}%
    ...
    \begin{wpdeliv}[due=24,id=del:portability_cygwin64,dissem=??,nature=??]
...
\end{wpdeliv}%
    ...
    \begin{wpdeliv}[due=12,id=del:semantic_interface_sage_gap,dissem=??,nature=??]
...
\end{wpdeliv}
    ...
    \begin{itemize}
      ...
      % \Wpdeliv{del:ipython_kernels_basic}{12}{Basic Jupyter
