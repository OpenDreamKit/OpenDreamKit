...
\begin{workpackage}[id=component-architecture,wphases=0-48!.5,
  ...
  \begin{task}[title=Modularization and packaging,id=mod-packaging,lead=UV,PM=20,partners={PS,LL},wphases=0-48]
...
\end{tasklist}
  ...
  \begin{wpdelivs}
    ...
    % \end{compactitem}}
    \begin{wpdeliv}[due=48,id=hpc-configure,dissem=PU,nature=OTHER,lead=UJF]
