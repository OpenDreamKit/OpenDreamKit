...
\item a library of parallel algorithms for algebraic computation. This
  ...
  mathematical tasks.  Specific targets include 
...
\end{itemize}
Ouput are \localdelivref{GAP-hpc-report}, \localdelivref{GAP-software-final} and~\localdelivref{GAP-APIs-report}.
\end{task}

The deliverables for this task are  \delivref{hpc}{GAP-hpc-report},
\delivref{hpc}{GAP-software-final} and \deliveref{hpc}{GAP-APIs-report}.
...
\begin{task}[title=Singular,lead=UK, PM=48, id=hpc-singular]
...
Output are \localdelivref{MPIRsuperoptimiser} and \localdelivref{MPIRfat}. 
\end{task}
...
%  LocalWords:  CilkRefman sage-paral-tree
