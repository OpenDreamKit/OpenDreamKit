...
\begin{WPDeliverables}
  \WPDeliverable{12}{del:MPIR_superoptimiser}{Extend the existing assembly
superoptimiser for AVX and upcoming Intel processor extensions}
  \WPDeliverable{24}{del:MPIR_processors}{Ongoing support of Intel, AMD, ARM, 
Sparc processors and new Operating System versions}
  \WPDeliverable{12}{del:MPIR_fat}{Provide FAT binary support for all new
x86_64 processors, build system maintenance and improvements to tuning,
