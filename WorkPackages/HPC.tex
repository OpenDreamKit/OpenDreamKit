...
\begin{task}[title=PARI,id=hpc-pari,PM=20, lead=UB,wphases=0-48!0.5]
  ...
  \localdelivref{sage-HPCcombi} and \localdelivref{pari-hpc3}.
\end{task}
...
\end{wpdeliv}
  ...
  {Devise a generic parallelisation engine and use it to prototype selected functions (integer factorisation,
