...
\begin{task}[title=HPC infrastructure for combinatorics,id=hpc-combi]
  ...
  tasks~\localtaskref{pythran-cython}, \taskref{component-architecture}{mod-packaging},
  and \taskref{component-architecture}{component-for-HPC}.
...
\begin{task}[title=Pythran-Cython convergence,id=pythran-cython]
  ...
  relevant \localdelivref{pythran-cython}. This would result in compiler-runtime
  ...
  \Pythran runtime \localdelivref{pythran-runtime}.
...
\begin{task}[title=\Pythran for \Sage and \Sage Users,id=pythran-sage]
  ...
  improve user kernels using the \Pythran compiler \localdelivref{pythran-sage}.
...
\end{wpdeliv}
  \begin{wpdeliv}[due=6,id=GAP-APIs,dissem=PU,nature=R]
...
\end{wpdeliv}
  ...
  \begin{wpdeliv}[due=12,id=GAP-lib-plan,dissem=PU,nature=R]
...
\end{wpdeliv}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=18,id=GAP-cython-design,dissem=PU,nature=R]
    {design for an adaptation of cython/pythran to the \GAP language}
  \end{wpdeliv}
  \begin{wpdeliv}[due=21,id=GAP-APIs-impl,dissem=PU,nature=OTHER]
      {a first implementation of the infrastructure APIs
  sufficient to support development and testing of the parallel
  library and experimental integration with other \TheProject components}
\end{wpdeliv}
...
\end{wpdeliv}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=30,id=GAP-lib-impl,dissem=PU,nature=OTHER]
      {a first parallel algebraic library covering the
  highest priority items identified}
\end{wpdeliv}
  \begin{wpdeliv}[due=36,id=GAP-cython-proto,dissem=PU,nature=OTHER]
...
\end{wpdeliv}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=47,id=GAP-APIs-final,dissem=PU,nature=OTHER]
      {a final implementation of the infrastructure APIs, suitable for release}
\end{wpdeliv}
  \begin{wpdeliv}[due=47,id=GAP-lib-final,dissem=PU,nature=OTHER]
      {the final parallel algebraic library, ready for release}
\end{wpdeliv}
  \begin{wpdeliv}[due=47,id=GAP-cython-final,dissem=PU,nature=OTHER]
...
\end{wpdeliv}
  \begin{wpdeliv}[due=48,id=GAP-lib-report,dissem=PU,nature=R]
      {report and evaluation of the final parallel algebraic library}
\end{wpdeliv}
  \begin{wpdeliv}[due=48,id=GAP-cython-report,dissem=PU,nature=R]
