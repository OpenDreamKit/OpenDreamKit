...
\item cohesiveness of communities of developers and users of open source softaware, and
...
\TOWRITE{DP}{Please deal with Neil's TODO below - if happy with it, just convert to comment}
\begin{tasklist}
