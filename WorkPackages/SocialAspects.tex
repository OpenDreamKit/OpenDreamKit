...
<<<<<<< HEAD
 \begin{wpdeliv}[due=24,id=jupyter-comment,dissem=PU,nature=DEM,lead=USH]
   {Demo: Mechanism for comment on posted Jupyter notebooks} 
=======
...
%  LocalWords:  localdelivref synthesised social-datareport textit WPref dksbases
%  LocalWords:  citeability isocial-decisionmaking social-tracaddon social-gametheoretic
%  LocalWords:  linebreak micromagnetics summarising optimise
