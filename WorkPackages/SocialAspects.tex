...
\begin{task}[title=Modern Distribution of Scientific Output]
  ...
  software and data.  \TOWRITE{NL}{One deliverable simple idea would
    be to enable the construction of 'Living Posters' which can be
    interacted with, targeted at large touch screens.}
\end{task}
...
\begin{wpdelivs}
  \begin{wpdeliv}[due=12,id=social-...,dissem=PU,nature=??]
      {...}
\end{wpdeliv}
 \begin{wpdeliv}[due=36,id=social-1,dissem=PU,nature=DEM]{Demonstrator: Jupyter Notebook Live Poster} \end{wpdeliv}
