...
\begin{task}[id=dynamic-inspect,title=Dynamic documentation and exploration system,lead=PS, partners={SR,USO,UV,LL}]
...
,id=vis3d,lead=SR, partners={US,PS,USO},PM=6]
...
,id=cfd-vis,lead=SR, partners={US,PS,USO},PM=4]
