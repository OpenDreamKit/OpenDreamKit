...
\begin{wpdescription}
  ...
  Quantopian, GraphLab, Enthought, Continuum, Authorea, BuzzFeed, etc.) and journalism (538, New
...
\begin{task}[id=notebook-verification,title=Using Notebooks for verification tests]
  ...
  notebook documents. The computed output will be compared against the stored
  output, and deviations reported as assertion errors. This allows the
  use of any notebook for automated regression testing.
  
  Jupyter notebooks store outputs as rich mime-type structures,
