...
\begin{wpdelivs}
  ...
  \begin{wpdeliv}[due=9,id=oommf-py,dissem=PU,nature=O,lead=USO]
    ...
    \end{wpdeliv}
    \begin{wpdeliv}[id=mws,due=9,nature=O,dissem=PU,lead=JU]
  ...
  \end{wpdeliv}
    ...
    \begin{wpdeliv}[id=notebooksearch,due=18,nature=O,dissem=PU,lead=JU,partners=USO]
...
\end{wpdeliv}
    \begin{wpdeliv}[id=adcomp,due=18,nature=DEM,dissem=PU,lead=JU,partners=USO]
  ...
  \end{wpdeliv}
    ...
    \end{wpdeliv}
    \begin{wpdeliv}[id=jupyter-import,due=24,nature=DEM,dissem=PU,lead=JU,partners=USO]
  ...
  \end{wpdeliv}
    ...
    \end{wpdeliv}
    \begin{wpdeliv}[id=cassearch,due=30,nature=O,dissem=PU,lead=JU,partners=USO]
  ...
  \end{wpdeliv}
\begin{wpdeliv}[id=nbad-search,due=42,nature=O,dissem=PU,lead=JU,partners=USO]
