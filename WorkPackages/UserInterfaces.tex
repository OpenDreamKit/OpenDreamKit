...
\begin{task}[title=Uniform notebook interface for all interactive
    components,id=ipython-kernels,lead=PS, partners={SR,USH,USO,LL,SA}]
...
\begin{task}[id=sage-sphinx, title=Refactor \Sage's \Sphinx documentation system, lead=PS,PM=6, partners={SR}]
...
\begin{task}[id=dynamic-inspect,title=Dynamic documentation and exploration system,lead=PS, partners={SR,USO}]
  ...
  \item Widgets based on the HTML5 and web component standards to display
    ...
    \TOWRITE{logilab}{"by Logilab PM=2" - this former remark 
    contradicts to Logilab involvement in this workpackage for 1 PM} 
