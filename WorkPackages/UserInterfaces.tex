...
\begin{wpdelivs}
  \begin{wpdeliv}[due=12,id=ipython-kernels-basic,dissem=??,nature=??]
      {Basic Jupyter interface for GAP, Pari, Sage, Singular}
\end{wpdeliv}
  \begin{wpdeliv}[due=12,id=ipython-kernels,dissem=??,nature=??]
      {Full featured Jupyter interface for GAP, Pari, Singular}
\end{wpdeliv}
  \begin{wpdeliv}[due=12,id=ipython-kernel-sage,dissem=??,nature=??]
