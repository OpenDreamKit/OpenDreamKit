...
\begin{task}[id=simulagora,title=Simulagora collaboration,lead=LL,PM=2,wphases=0-12]
  \TOWRITE{Logilab}{This is a very short task, should either be extended or converted to a deliverable and integrated with another task (it also has no deliverables associated}
...
\begin{task}[lead=UB,title=Common option system for various displays
  ...
  will benefit of the work done in task~\taskref{UI}{cfd-vis}.
\end{task}
