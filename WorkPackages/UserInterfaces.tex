...
\begin{wpdelivs}
  ...
  \end{wpdeliv}
    ...
    \begin{wpdeliv}[id=notebooksearch,due=18,nature=O,dissem=PU,lead=JU]
...
\end{wpdeliv}
  ...
  \end{wpdeliv}
    ...
    \end{wpdeliv}
    \begin{wpdeliv}[id=cassearch,due=30,nature=O,dissem=PU,lead=JU]
  ...
  \end{wpdeliv}
\begin{wpdeliv}[id=nbad-search,due=42,nature=O,dissem=PU,lead=JU]
