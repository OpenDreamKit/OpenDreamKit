...
%refer to deliverable: 
  ...
  studies for their work (see introduction \TOWRITE{HF}{Need to
    introduce the overall idea somewhere}). These researchs in
  academia and industry are typically not computationalists and use simulation
  to support their experiments and analytical work.
  ...
  software (\localtaskref{oommf-nb}).
\end{task}

\begin{task}[lead=USO,title=Demonstrator: micromagnetic VRE, 
  id=oommf-tutorial-and-documentation, PM=7]
  ...
  We will create executable documents within the micromagnetic VRE
...
\begin{wpdelivs}
  ...
  \end{wpdeliv}
    ...
    \begin{wpdeliv}[due=15,id=oommf-nb,dissem=PU,nature=DEM,lead=USO]
      {Micromagnetic VRE software completed (\OOMMFNB{})}
    \end{wpdeliv}
