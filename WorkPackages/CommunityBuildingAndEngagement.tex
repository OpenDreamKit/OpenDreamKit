...
\begin{wpdelivs}
  \begin{wpdeliv}[due=6,id=ws1,dissem=??,nature=??]{Workshop 1}
  \end{wpdeliv}
  \begin{wpdeliv}[due=12,id=needs,dissem=??,nature=??]{Report on community needs}
  \end{wpdeliv}
  \begin{wpdeliv}[due=18,id=ws2,dissem=??,nature=??]{Workshop 2}
  \end{wpdeliv}
  \begin{wpdeliv}[due=30,id=ws3,dissem=??,nature=??]{Workshop 3}
  \end{wpdeliv}
  \begin{wpdeliv}[due=42,id=ws4,dissem=??,nature=??]{Workshop 4}
  \end{wpdeliv}
\end{wpdelivs}
\end{workpackage}
%%% Local Variables:
