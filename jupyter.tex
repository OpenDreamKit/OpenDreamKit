...
\TOWRITE{HF}{Nicely done to include the embed the picture in the
  text. Please rebuild the picture with a 1.4 larger zoom factor; this won't
  create much line splitting and make for a larger font.}
