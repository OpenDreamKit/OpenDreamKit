...
\ODK is also working on its communication and visibility. After
...
thanks to months of intensive and expert work by our recruit at \site{PS}
Erik Bray, this challenge is about to be tackled, almost one year
...
Task~\taskref{hpc}{pythran} is making good progress towards the development of Pythran and its
...
delayed due to the difficulty of hiring an engineer for the task. It is now
...
As planned, we are regularly shift manpower around to adapt for the
