...
\delivref{hpc}{pythran-typing} has been postponed from month 9 to month
...
projects.
\todo[inline]{Is that (above) an early start? A late start? How do the many PM
play into this? this could be clarified.}
...
\end{compactitem}
\todo[inline]{the above two items are both labelled ``D1'' -- this
  seems wrong?}
...
\inline[todo]{has this been done by Fall 2016 as claimed? in any case it shouldn't be said as if in the future? or we are pretending to be writing this earlier?}
...
task~\delivref{component-architecture}{portability-cygwin}.  On
