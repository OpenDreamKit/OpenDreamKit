...
Following the retirement of Ursula Martin, Dmitrii Pasechnik has
become the lead PI for this work package.
\TODO{Dima: say a word about the new opportunities for collaborations
  in Oxford}
...
patricular the state of affairs in our model system \Sage, is well on
...
\TODO{Dima: is there a way to give in a few words a rough idea of the
  findings in the above? Think that you want to grab the attention of
  fellow ODK members or Sage devs that will be reading this document,
  and get them to read the papers.}

\TODO{Dima: a word on planned workshops to foster the work on this WP?}
