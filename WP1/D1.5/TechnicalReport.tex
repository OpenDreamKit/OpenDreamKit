...
\title{Periodic Technical Report II (Months 19-36), Part B}
...
\begin{abstract}
This is \ODK's Technical Report for Reporting Period 2. As such, it
provides an overview of the project achievements, by objectives, work
packages, and tasks from March 2017 to August 2018, and their impact.
It also explains how reviewer's recommendations were tackled and
discusses risk and quality management and deviations from the original
plan.
\end{abstract}
