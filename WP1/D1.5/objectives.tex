\subsection{Recap: Aims and Objectives of the OpenDreamKit Project}
...
\item\label{objective:framework} ``\emph{To develop and standardise an architecture
  ...
  \item Collaborative workspaces: major \JupyterHub developments,
    see~\longtaskref{UI}{notebook-collab}; study and documentation of the \SMC
    architecture, see \longtaskref{component-architecture}{extract-smc};
...
\item \label{objective:community} ``\emph{To bring together research
  ...
  \item Sharing best practices for packaging, building containers
    (see~\localtaskref{component-architecture}{mod-packaging}), and
    testing
  ...
  \item Work on interfaces between systems; see
    \localtaskref{component-architecture}{interface-systems}, \localtaskref{UI}{mathhub},
    and \localtaskref{UI}{pari-python};
...
\item \label{objective:updates} ``\emph{Update a range of existing open source
  ...
  \item Continuous efforts of development, release and integration within \Sage
    ...
    fflas-ffpack and Givaro (Deliverable~\delivref{hpc}{LinBox-algo})
    \item the PARI library for computational number theory
    (Deliverable~\delivref{hpc}{pari-hpc2} still ongoing)
    \item the GAP software for computational group theory
    (Deliverable~\delivref{hpc}{GAP-HPC-report} still ongoing)
        \end{itemize}

  \item Packaging efforts: Docker containers (delivered and regularly updated), Debian and
    Conda packages (beta); see \localtaskref{component-architecture}{mod-packaging}.
  \item Ongoing work in \WPref{hpc} to better support HPC in the individual mathematical
  ...
  \item Integration of all the relevant mathematical software in the uniform \Jupyter user
    ...
    see \localtaskref{UI}{ipython-kernels}.
  \end{itemize}
\end{oldpart}
...
\item Refactoring \Sage's documentation build system to contribute many local developments
  upstream (\Sphinx) \localtaskref{UI}{sage-sphinx};
\item Outsourcing and contributing upstream as \Python bindings the existing \Sage
  bindings for many computational systems; see \taskref{UI}{pari-python}.
\end{itemize}
