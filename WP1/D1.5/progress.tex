\section{Progress on the project (Overview)}
...
\item \emph{Studies of Social Aspects} (\textbf{WP7}): analysis of user needs and research
  into collaborative and open software development in mathematics and science.\ednote{MK:
    here we still reference WP7, which does not have its own subsection in
    Section~\ref{sec:achievemnts}. Somwhere we are missing an explanation}
\end{itemize}
