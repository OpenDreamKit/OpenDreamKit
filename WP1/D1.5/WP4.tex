...
The \Jupyter-based prototype for this is delivered in \milestoneref{UI-vre-prototype}.
\taskref{UI}{vis3d} adds interactive visualization to this environment,
expanding what is possible in an interactive \Jupyter environment.
We are on track to deliver real-time collaboration to this VRE via JupyterLab in \taskref{UI}{notebook-collab} via \delivref{UI}{jupyter-live-collab}.
The final stage of taking work performed in this VRE into publication / knowledge system is enabled by \taskref{UI}{structdocs} and WorkPackage 6.
