...
With these results, we can produce a \Jupyter-based prototype VRE,
...
The sphinx documentation system has been significantly improved,
especially for Cython-generated packages, such as those in \taskref{UI}{pari-python}.

\subparagraph{\longtaskref{UI}{dynamic-inspect}} Due M36 (D4.16)

\longdelivref{UI}{ipython-advanced-interacts} is delivered in the form of \emph{Sage Explorer},
a new package developed by \ODK.
Sage Explorer provides rich, interactive exploration of objects and their properties in \Jupyter.
Sage Explorer builds on the robust foundation of Jupyter Widgets to provide interactivity,
enabling rich, detailed, and efficient interactive exploration of mathematical objects,
especially those found in combinatorics and discrete mathematics.
Sage Explorer is \href{demonstrated online}{https://github.com/sagemath/sage-explorer} via the Binder service.
