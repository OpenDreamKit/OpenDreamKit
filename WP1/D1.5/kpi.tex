...
Quantitative metrics: Web site Statistics
\begin{itemize}
\item Project activity
\item added metrics:
7 activities on the website 
31 blogs (28 blogs and 3 technical blogposts)
471 followers with 1744 tweets
6 press releases
6500 visits in 2018
...
Stories of Mike (Michael Croucher): Michael is a Research Software Engineer at the unievrsity pf Sheffield, passionate about improving the 
...
3 Blogs about how to deploy VRE:
Luca De Feo: Deploying a containerized JupyterHub server with Docker %https://opendreamkit.org/2018/10/17/jupyterhub-docker/
Nicolas Thiéry: Toward versatile JupyterHub deployments, with the Binder and JupyterHub convergence %https://opendreamkit.org/2018/03/15/jupyterhub-binder-convergence/
Loic gouarin: Deploying JupyterHub with Kubernetes on OpenStack %https://blog.jupyter.org/how-to-deploy-jupyterhub-with-kubernetes-on-openstack-f8f6120d4b1
...
9 Jupyter deployments:%https://github.com/OpenDreamKit/OpenDreamKit/issues/174

Local CoCalc instance at Universität Zürich. Deployed September 2015 - February 2016.

[Instance of JupyterHub](https://jupyter.math.cnrs.fr/hub/) deployed by the [Mathrice group](http://mathrice.fr/)
Host Infrastructure: France Grille's LAL cloud
Users: members of math labs in France
Main use case: casual use 

[JupyterHub instance at Université Paris Sud / Paris Saclay](http://jupytercloud.lal.in2p3.fr/)
Host Infrastructure: France Grille's LAL cloud
Users: personnel and students of UPSud / Paris Saclay
Main use case: use in classroom (Python, Sage, C++), casual use
 
JupyterHub instance deployed on USheffield's HPC system ttp://docs.iceberg.shef.ac.uk/en/latest/using-iceberg/accessing/jupyterhub.html
 
JupyterHub instance(s) deployed at UVSQ %https://opendreamkit.org/2018/10/17/jupyterhub-docker/
Main use case: use in classroom (Sage, Python, C, Apache Spark), casual use
     
[Gallery of JupyterHub instances](https://jupyterhub.readthedocs.io/en/latest/gallery-jhub-deployments.html)
...
\item Best practice and tools for correct and reproducible research
 ...
 Mike Croucher's talk ``Is your research software correct''
 ...
 delivered in several of ODK's many training events.
  ...
  Success of Tania's Workshop on Jupyter notebooks for reproducible research
...
A serie of Use cases - examples of work that have been made possible through the OpenDreamKit project.The general structure is to describe a work requirements what is required followed by a solution using OpenDreamKit supported tools. Where appropriate, we provide links to related examples, and provide more details.  
    
4 use cases: %see:https://opendreamkit.org/tag/use-case
Nicolas M. Thiéry: Publishing reproducible logbooks 
Nicolas M. Thiéry: Live online slides with SageMath, Jupyter notebooks, RISE and Binder
Michael Kohlhase: WP6 Math-in-the-Middle Integration Use Case to be Published at MACIS-2017 (two papers) 
Michael Kohlhase: Mixing Data and Computation to explore mathematical data sets: Knowledge to the rescue with LMFDB + SageMath + Pari + MitM 
...
8 training workshops were organised in developing countries including Algeria, Liban, Tunisia, Colombia, Morocco and Mexico,attended by about 451 trainees.
...
Stories about the impact of the Micromagnetics VRE;
