...
\item[-] Luca De Feo: Deploying a containerized JupyterHub server with Docker %https://opendreamkit.org/2018/10/17/jupyterhub-docker/
...
\end{description}
\begin{itemize}
\item 9 Jupyter deployments:%https://github.com/OpenDreamKit/OpenDreamKit/issues/174
...
\begin{description}
\item [Use of ODK's computational components in collaborative workspaces] A group of mathematical researchers with access to common 
computational resources, such as a shared lab computer or cloud servers,has 
