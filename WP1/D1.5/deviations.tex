...
A major deviation from the work plan for CNRS was an overspending of PM in \WPref{hpc} and
underspending in \WPref{UI}. This reallocation is due to a change of priorities in the tasks
assigned to CNRS and the specific competences of the hired engineer. In particular we will
not implement \taskref{Sage-display}. We thought that \taskref{Sage-display} was a good idea
...
bet, we decided to put the 26PMs initially allocated \WPref{UI} to safer and more essential points related to
\WPref{hpc}. Additional efforts have been and will be made to
...
we used an expected rate of \euros 1 = \pounds 0.69. In our most recent financial report we used an actual
rate of \euros 1 = \pounds 0.88. The monthly rates paid in pounds have been in line with our budget as had the 
