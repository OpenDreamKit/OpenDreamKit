...
assigned to CNRS. The 26PMs initially allocated \WPref{UI} will be spent instead on
\WPref{hpc}. In particular we will not implement \taskref{Sage-display} that we believe
is secondary. Additional efforts have been and will be made in \WPref{hpc} in order to
provide Windows support for the \DOK components, enhance the parallelization of PARI/GP
and work on the Python3 compatibility of \Sage.
