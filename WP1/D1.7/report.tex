...
\item[Best practice and tools for correct and reproducible research]
  \TODO{@embray? update this paragraph}
  ...
  \item[Multisystem architecture]
    \TODO{@jdemeyer, @embray: expand/update this a bit; maybe giving
      some concrete examples as in the previous item with links to
      deliverables}
