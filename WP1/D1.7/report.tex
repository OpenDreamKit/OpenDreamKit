...
\subsection{ODK's web site and infrastructure}

\ODK's website at opendreamkit.org is hosted for free on the GitHub-pages service.
There is no ongoing cost to host the website beyond the low cost of renewing the \url{opendreamkit.org} domain
which will be covered by the coordinators lab.
...
Most of ODK's infrastructure is based on a dozen of mailing lists
(hosted by french's public CNRS service), and public GitHub
