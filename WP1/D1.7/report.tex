...
Throughout the project from Sept. 2015 to August 2019, 27 events (development workshops and project meetings, training worksops or sessions, community building workshops, research workshops, etc.) were (co-)organised by ODK. Some of them were of course planned in Europe and North America, but others were planned in Africa, South America and Middle East ( see D1.5 "Key Performance Indicators for Aim 4  and for the events organised during the last reporting period: D2.15 "Community Building, Training, Dissemination, Exploitation, and Outreach). 
