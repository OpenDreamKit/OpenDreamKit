...
example is the Coding Theory framework), the review process still
...
UI migrated to Jupyter, \PariGP interface migrated to CyPari, signals
...
issue trackers, using whatever processes and tools the project may see
fit. %
...
Secondly, historically new \Sage who wanted to share their code were
encouraged to include it in the \Sage sources. %
...
component of \Sage, the community can take over maintainance and
integrate it to the code base.
