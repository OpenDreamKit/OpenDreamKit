...
\item[Best practices and tools for correct and reproducible research]
  ...
  practices whenever software is used in research, including open code
  ...
  testing. A lot of the work in ODK relates to disseminating those
  best practices (\longWPref{dissem}), and enabling them through
...
regression testing, code reviews, coding sprints, ...
