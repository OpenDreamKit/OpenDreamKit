...
An amendment to the grant agreement\ednote{@NT: Is there a formal reference to this, e.g., by number of date? (It's OK to ignore this ednote.)} introduced the new task \taskref{dksbases}{isabelle}.
...
FAU has subcontracted the Isabelle case study (\taskref{dksbases}{isabelle}) to Dr. Makarius Wenzel's company sketis.net.
