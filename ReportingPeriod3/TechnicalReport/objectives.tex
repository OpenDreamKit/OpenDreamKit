...
\item \label{objective:community}
  ...
  \ednote{@minrk: update for RP3: key outcomes of dev workshops
  ...
  \item Sharing of best practices in developping modularized parallel linear algebra kernels and there integration into \SageMath (see \longlocaltaskref{component-architecture}{component-for-HPC})
