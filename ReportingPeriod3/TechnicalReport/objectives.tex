...
In the first two reporting periods \textbf{WP6} has developed the Math-in-the-Middle ontology that acts as the pivot point mediating between system languages in the MitM interoperability framework.
This work has been reported in deliverables \textbf{D6.5} and \textbf{D6.8}.
