...
\item\label{objective:framework} \textbf{Virtual Research Environment Kit:} ``\emph{To develop and standardise an architecture
  ...
  \ednote{@defeo, @minrk, @kohlhase: update for RP3: work carried out for Objective 1: Virtual Research Environment Kit}
...
\item\label{objectives:core} \textbf{Core Components:}
  ...
  and~\ref{aim:sharing}.}''
  \ednote{@defeo, @minrk, @kohlhase: update for RP3: work carried out for Objective 2: Core Components
    Maybe: mathhub development? data portal?
...
\item \label{objective:community}
  ...
  \ednote{@defeo, @kohlhase, @minrk, @ClementPernet: update for RP3: key outcomes of dev workshops
    Maybe: conda packaging, continuous integration, data portal, ...
    }
...
\item \label{objective:updates}
  ...
  \ednote{@defeo, @ClementPernet, @kohlhase?: update for RP3: work carried out for Objective 4: Updates to Mathematical Software Components}
...
\item \label{objective:data}
  ...
  \ednote{@kohlhase: update for RP3: work carried out for Objective 7: Next Generation Mathematical Databases
    persistent memoization deliverable + all the database work
  }
