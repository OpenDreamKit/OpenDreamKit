...
\item\label{objective:framework} \textbf{Virtual Research Environment Kit:} ``\emph{To develop and standardise an architecture
  ...
  \ednote{@minrk: update for RP3: work carried out for Objective 1: Virtual Research Environment Kit}
...
\item\label{objectives:core} \textbf{Core Components:}
  ...
  and~\ref{aim:sharing}.}''
  \ednote{@minrk: update for RP3: work carried out for Objective 2: Core Components}
...
\item \label{objective:community}
  ...
  \ednote{@minrk, @ClementPernet: update for RP3: key outcomes of dev workshops
...
\item \label{objective:updates}
  ...
  \ednote{@ClementPernet: update for RP3: work carried out for Objective 4: Updates to Mathematical Software Components}
...
\item \label{objective:disseminate}
  ...
  29 organized events: 7 development workshops, 10 training and community building
  workshops ( including one targeted at women and one in a developing country),1 research conference 
  and 11 communication and participation in external events, all organized during the third reporting period. See
