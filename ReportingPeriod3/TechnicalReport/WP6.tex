...
\ednote{extend MathData as key result of RP 3}

\begin{oldpart}{from TR2, some of this can be summarized; instead mention Wenzel subcontract}
...
In particular the value of the exemplary verification of an LMFDB algorithm in \localtaskref{dksbases}{data-LMFDB} and deliverable~\longdelivref{dksbases}{lfmverif} seems highly questionable.
...
\ednote{to be written by sites US,PS,UW}
\medskip
...
We report on this task in detail in \ednote{refer to deliverable}.
\medskip
