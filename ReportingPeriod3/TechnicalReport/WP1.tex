...
\item Following the recommendations from the reviewers after the first
  ...
  that were implemented in the 3rd amendment. The 4th amendment, we revised the GA to add the Universitu of Leeds to the list of beneficiaries and  to reallocate staff and all remaiing resources not used by USHD to UNIVLEEDS. 
...
\item \site{PS} organized the first project review in Brussels with
  ...
  (February 2018),  at \site{XFEL} (June 2018) and during The Cirm conference in Marseille (February 2019) Videoconferencing . The final review meeting will take place
