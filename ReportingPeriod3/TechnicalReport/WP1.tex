...
\item \site{PS} organized 2 project reviews with the Funding agency, 
...
on October 2018, and 3 steering committee meetings, in Brussels (March 2017), online
  ...
  During period 3, \site{PS} continued to run regular meetings, one in Marseille 
...
\item Finally \site{PS}After the total failure to recruit women during the 
