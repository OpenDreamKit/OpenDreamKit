...
\begin{itemize}
\item \site{PS} led the 2nd, 3rd, 4th and 5th amendment to the consortium,
...
\item Following the recommendations from the reviewers after the first
  reporting period, \site{PS} also led the work plan revision process
...
\item \site{PS} organized the first project review in Brussels with
  ...
  (February 2018),  at \site{XFEL} (June 2018) and in Marseille (February 2019), during The Cirm conference. 
  The final review meeting will take place in the European Commission
  representation\ednote{I'm not sure what this word should be but
    representation makes no sense here in English} in Luxembourg on october 30, 2019.
...
\item \site{PS} produced a second version of the Data Management Plan
  (\delivref{management}{data-plan2}). \ednote{Innovation Management Plan}
