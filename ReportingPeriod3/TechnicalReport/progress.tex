...
\ednote{Two paragraphs of explanation about the specific difficulties
  of evaluation: we don't have a single well-defined product, and we
  capture a very diverse crowed of end-users; hence formal methods of
  evaluation (polls, ...) can't be applied; instead ... }
