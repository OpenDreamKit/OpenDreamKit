...
\end{recommendation}
\ednote{@MichaelKohlhase: MitM use case and comic
  The comic is ready: \url{https://github.com/OpenDreamKit/OpenDreamKit.github.io/blob/master/public/images/use-cases/MitM.png}
  A use case with this comic should appear on https://opendreamkit.org/tag/use-case;
  maybe merging with one of the earlier use case?
}
...
\end{recommendation}
\ednote{@MichaelKohlhase: disseminating adoption of Logipedia}
