...
\ednote{@mikecroucher, @trallard, @fanghor: proofread brief overview of work done on T2.6: Introduce OpenDreamKit to Researchers and Teachers}
...
\ednote{@fanghor: update for RP3: brief overview of work done on T2.7, T2.8 micromagnetism VRE}
...
\ednote{@defeo: update for RP3: brief overview of work done on T2.10: Computational mathematics resources indexing service”
  anything to report here? Or just state that all the work was done during RP2?}
