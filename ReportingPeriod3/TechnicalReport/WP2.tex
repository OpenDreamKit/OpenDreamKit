...
\paragraph{Overview}
  ...
  PyLadies. We continued to organize specific events in developing countries: Colombia, Mexico, Morocco, Lebanon, Tunisia, Nigeria.

  Finally, this third period was also an occasion to improve our online communication,continuously updating the website with new content. Following the advice of our last review, % here are the recommendations after the RP2 review, have the recommendations been followed or not?
  %greater attention mus be paid to acknowledgement of EU funding in all areas ( give examples)
...
for the pas two years. We have been organizing 14 events covering subjects such as: Jupyter, JOOMMF,
