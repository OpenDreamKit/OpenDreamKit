...
\ednote{@nthiery, @IzabelaFaguet, @VivianePons: update WP2 for RP3
  - Update T2.1, notably production of comics and videos DONE by @VivianePons please check
  - update the figures in the overview, T2.3, and T2.5; highlight e.g. CIRM DONE by @VivianePons please check
  - ...?
}
...
\paragraph{Overview}
  ...
  We have continued the work started during periods one and two, especially on \longlocaltaskref{dissem}{dissemination-communication} and
  \longlocaltaskref{dissem}{dissemination}, organizing or participating in about 30 events throughout the last year, making a total of 110 event throughout the four years. In particular, we organized the \emph{Free Computational Mathematics} 
...
The comics designed by Juliette Belin were published on our ``Use Cases'' section, giving a quick and practical overview on how to use some of \ODK tools.
