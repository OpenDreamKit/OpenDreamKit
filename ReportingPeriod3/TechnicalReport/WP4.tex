...
\ednote{@minrk: detail work on and state of real time collaboration in RP3
  our reviewers are explicitly asking us for it}
...
\ednote{@nthiery, @zerline: briefly report on T4.5: dynamic documentation and exploration system
  progress on sage-combinat-widgets and sage-explorer during RP3}

During RP3 for \longdelivref{UI}{ipython-advanced-interacts}, \ODK packages
...
A new \emph{Francy Widget} package has been developed to take care of graph graphical representation
...
\ednote{@kohlhase: proofread/update report on T4.6: structured documents}
...
\ednote{@kohlhase: proofread/update report on T4.7 active document portal}
...
vector field objects, and GUI elements for data exploration.
We have used dissemination workshops
