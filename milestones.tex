...
\begin{milestones}
  ...
  verif={2nd Project meeting report. Completion of corresponding deliverables.}]
  {Startup}
  {Requirements study, design and prototype implementations. Start of community building.}

  \milestone[id=proto1,month=24,
  verif={4th Project meeting report. Completion of corresponding deliverables.}]
  {Prototypes}
  {First fully functional interface implementations. Enhanced versions of \TheProject components.
         Training early adopters.}

  \milestone[id=community,month=36,
  verif={6th Project meeting report. Completion of corresponding deliverables.}]
  {Community/Experiments}
  {Evaluating \TheProject software. Working with the community 
         and building portfolio of experiments produced with \TheProject.}

  \milestone[id=eval,month=48,
  verif={8th Project meeting report. Completion of corresponding deliverables.}]
  {Evaluation}
  {Project evaluation and final versions of all \TheProject components.}
\end{milestones}
