...
\begin{abstract}
  ...
  \TheProject will deliver a flexible toolkit that will enable the
  project consortium as well as end users to easily set up Virtual
  Research Environments, customised to meet the diverse needs of
  collaborative research in pure mathematics and applications, and
...
frameworks and standardization of software systems.  We also study
