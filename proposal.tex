...
other. It has \Sage worksheets, powerful \LATEX editing features and a
full \Linux computer, all accessible from a standard web browser. Its
main design feature is to enable and promote collaboration between
groups of users. It is for example a natural place to host a course,
allowing teachers to collaborate with their students using modern
tools like \Sage and \LATEX, with facilities for real-time
communication through chat, video, and shared editing of documents,
programs and \Sage worksheets; course material can be provided as
\Sage worksheets, assignments can be distributed, collected, and
returned as well. Launched in 2013, \SMC presently hosts over 100,000
projects and 10,000 weekly active users. This fast adoption by a wide
variety of users showcases the relevance and the long term impact this
kind of collaborative environments can have.
...
Washington at Seattle, with a business plan in the work for
commercializing high-end plans in parallel to free plans, in order to
gather funding for \Sage development.
...
\TheProject, paving the way and showcasing the important features from
the users perspective. On the other hand, basically each and every
task undertaken in \TheProject will benefit back \SMC.
