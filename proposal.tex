...
\TODO{Something about the special value of collaborative VREs for
  mathematics -- research groups are small and can be isolated.}
...
\TODO{Maybe split this into architecture/framework -- basically a collection of
  APIs; and an initial core set of components}

\TODO{Semantics of APIs}
...
\item \label{objective:updates} Update existing components for seamless deployment and efficient
