...
\TOWRITE{NT}{On the title page, there are many question mark pairs (??) -- they should go before submission}
\begin{abstract}
...
\end{itemize}
\end{proposal}
\TOWRITE{ALL}{Seach through final.pdf ('make final') and look for questions marks ?? and XX and YY and XYZ as place holders where people intended to later add a link, or where a link is broken.}
\end{document}
