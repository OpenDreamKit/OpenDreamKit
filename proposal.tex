...
\begin{description}
\item[Aim 1:] Build collaborative open source tools that support the
  entire life-cycle of computational work in mathematical research,
  from initial exploration to publication and teaching.

  % Our tools will span the entire life-cycle of a research idea, . They will enable
  % reproducible research as a natural outcome and will bridge the gaps
  % between code, published results and educational materials. This
...
\TOWRITE{JC}{One paragraph description of the LMFDB grant}
\TOWRITE{JC?}{One paragraph description of how it relates to this grant}
...
\TOWRITE{JC}{Description of Warwick}
\TOWRITE{LD}{Description of Versailles}
\TOWRITE{Logilab}{PIC for Logilab}
\TOWRITE{MK}{PIC for University of Silesia}
\TOWRITE{JC}{PIC for Warwick}
