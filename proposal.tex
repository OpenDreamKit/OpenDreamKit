...
\item in open source: \TODO{early examples of open source?},
...
\item The Jupyter project tries to equip SAGE with a notebook interface that makes
  \TODO{\ldots short characterization\ldots}
\end{compactitem}
...
\item \label{objective:data}Identify and extend ontologies and standards to
  ...
  \TOWRITE{POD}{write detailed description of Objective Data; improve
    consistency of the short description w.r.t. the Databases
    work package (in particular provenance w.r.t. traceability)}
