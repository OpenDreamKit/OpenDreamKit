...
(Objective~\ref{objective:framework}). They will be supported in this
objective by \ref{smc} and \ref{jupyter} which bring respectively
expertise in the key technologies \SMC and \Jupyter. They will also
benefit from the \textbf{diversity of real world use cases from all
  areas of scientific computing, in academia and industry} provided by
\ref{jupyter}, \ref{logilab}, and~\ref{silesia}.
