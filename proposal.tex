...
\item \label{aim:collaboration} Improve the productivity of
  ...
  \textbf{software}, \textbf{data}, and \textbf{knowledge}.
...
\item \label{objective:sustainable} Foster a sustainable ecosystem of
  ...
  communities whenever suitable. This fulfills part of Aim~\ref{aim:sharing}.
...
\paragraph{Objective~\ref{objectives:tools}: \TODO{title}}\ 
...
purpose systems for pure mathematics. The rapid takeoff of Sage in
...
\paragraph{Objective~\ref{objective:disseminate}: \TODO{Title}}\ 
...
\TODO{ lmfdb, oeis, and findstat have a strong knowledge component as
  well, with knowls and wikis, references, ...}

\TODO{arxiv is not far from a database of knowledge}
