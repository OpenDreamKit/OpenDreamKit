...
\begin{abstract}
  ...
  \TheProject will deliver a flexible toolkit that will researchers in
  pure mathematics and its applications to easily set up Virtual
  Research Environments customised to meet the diverse needs of
  their various research projects and
  built out of a sustainable ecosystem
  of % both domain-specific and general purpose
  community-developed open software, databases, and services. These
  environments will be capable of supporting seamlessly the full
  life-cycle of mathematical research, from initial exploration,
  through proof and publication to archival and sharing of data and software.
  ...
  To achieve this we will define a novel component-based VRE
  architecture and adapt a wide range of existing mathematical
  software, databases, and UI components to work within it and to work
  well on modern high-performance hardware. We will build in interfaces
  to standard HPC and grid services and components, so that they can
  be used as needed.  Our arhcitecture and VRE designs will be
  informed by recent research into the sociology to mathematical
  collaboration, to ensure that they properly support actual
  ...
  publications based on executable documents, and implement demonstrator
  VREs based on OpenDreamKit.
