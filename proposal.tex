...
\begin{abstract}
  \TOWRITE{All}{The abstract can be expanded from the current 1100
    characters to as much as 2000}.
...
\item\label{objective:framework} To develop and standardize an
  ...
  \ref{aim:collaboration} and~\ref{aim:sharing}. %%\TODO{This is a bit
    long}
...
are based on (iii)~applications of mathematics and also require
...
interface of each computational component to \Jupyter, ensuring that
\Jupyter stands up to the stringent needs of the community. \Jupyter's large industrial and academic user base will benefit from these contributions, but is not reliant on the mathematics community (either in development effort or for funding) to remain sustainable.
...
\TOWRITE{MK}{Proofread 3. work package (except for the work packages themselves) pass 1}
\TOWRITE{ALL}{Proofread 3. work package (except for the work packages themselves) pass 2}
...
\TOWRITE{MK}{Proofread 3.1 work plan (except for the work packages themselves) pass 1}
...
Different communities will be brought together within the work package~\WPref{component-architecture},
...
We will demonstrate and explore the effectiveness of the VREs through our dissemination work package \WPref{dissem} and our focus on the social aspects of collaborative research in \WPref{social-aspects}.
...
\TODO{ALL}{The gantt chart is very ugly. As soon as work packages, tasks and deliverables are definitely
