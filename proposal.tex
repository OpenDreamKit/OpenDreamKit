...
\item \label{aim:collaboration} Further promote collaborations of
  researchers on Mathematical \emph{software}, \emph{data}, and
  \emph{knowledge}.
...
\item Performance, portability (local, cloud, ...)
