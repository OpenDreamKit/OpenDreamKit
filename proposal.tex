...
Environments tailored to the \TODO{versatile} needs of collaborative
research in pure mathematics and applications, and based on an
ecosystem of domain specific and general purpose community developed
open software, databases, and services.
...
e.g. \GAP, \Linbox, \Pari, \Sage, or \Singular, and of interactive
scientific computing environments like \IPython showcase the viability
of community development models for such components.

The recent success of the Virtual Research and Teaching Environment
SageMathCloud (with more than 10k users and 100k projects after just
one year) or of the online number theory database LMFDB showcases the
strong need for \emph{integrated solutions} enabling large-scale
collaboration on \emph{knowledge}, \emph{data}, and \emph{software}.

Yet setting up infrastructures like the above currently requires
massive ad-hoc efforts. Challenges include portability, compatibility,
performance, usability, reproducibility, not withstanding the many
...
\TODO{Better explain the specific needs in maths, and why we focus on
  VRE bricks rather than VRE themselves, in the DIY spirit.}
...
\item \label{aim:vre} Make it easy for teams of
  ...
  Environments tailored to their needs and workflow, supporting the
...
\item \label{aim:sharing} Identify and promote best practice in
  ...
  acessible and sharing data in a semantically sound way.
...
\item \label{objective:devel}Identify and promote software development
  best practices that will ensure the long term sustainability of an
  ecosystem of interoperable open source components, developed by
  overlapping communities.  \TODO{NT: write detailed descriptions}
...
Technically speaking, \SMC is a specific cloud-based Virtual Research
and Teaching Environment for mathematics, based on open source
technology. It's currently developed and deployed at the University of
Washington at Seattle, with a business plan in the work for commercial
support for massive on line courses, subsidizing free access for all
other academic usage some further \Sage development.
