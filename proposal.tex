...
\begin{abstract}
  \TODO{This can be expanded from the current 770 characters to as
    much as 2000}.
  ...
  maximize sustainability and broad impact, with beneficiaries
  extending to scientific computing, physics, chemistry, biology,
  engineering, medicine, earth sciences, and geography, and including
  researchers as well as teachers, and practitioners in the industry.
\end{abstract}
\tableofcontents
...
\begin{quote}There will be positively no internal alterations to be
  ...
  720.\end{quote}.  
More recently, on
the Web standards front, MathML was the first XML recommendation, while
\url{planetmath.org} has been Web 2.0 even before Wikipedia. Meanwhile Computer
...
Number Theory in
1979, and including \GAP in Group Theory or
...
For a long time, those systems remained limited to specific research
topics and non-interoperable. At that time the mathematical research
community could not concentrate sufficient manpower in -- in
particular by lack of yet to come large scale community development
models and tools -- to assemble a broad range of capabilities in a
uniform computational framework and give it a coherent mathematical
user interface. Thus general purpose systems, supporting a broad
range of engineering mathematics, arose in the 1980s and 1990s mostly
from US-based commercial companies like Wolfram and MapleSoft,
creating a profitable industry.

However, the last decade has witnessed the remarkable emergence of
\Sage, a truly general purpose computational mathematical system
committed to and drawing huge benefits from the power of open source
software a virtual software development environment. Its wide success
and acceptance showcases the viability of user-driven community
development models to deliver high quality software to researchers,
teachers, and practitioners in mathematics. The fist key factor to the
success and sustainability of \Sage is its intrinsically international
nature; the second one is summarized in its motto: ``Build the car,
don't reinvent the wheel''. \Sage is indeed built on a large stack of
existing open source software, ranging from the aforementioned
specialized computational systems, to \Python, a general purpose
programming language that is used by millions of programmers
worldwide. This architecture enables to focus on the specific needs of
the community while externalizing most of the general purpose
development efforts.
...
\begin{center}
  \begin{boxedminipage}{.95\textwidth}\em
    ...
    The next horizon is to deliver complete Virtual Research
...
The first attempt in this direction to gain any real traction is the
Virtual Research and Teaching Environment \SMC (hosting more than 10k
users and 100k projects after just one year). There has also been
considerable activity, for years and sometimes decades, in a range of
online mathematical databases such as the Online Encyclopedia of
Integers Sequences, the Atlas of Group Representations, and
\LMFDB. These show the community interest in well-executed
\textbf{integrated solutions} which can enable large-scale
collaboration on Mathematical \textbf{software}, \textbf{knowledge},
and \textbf{data}.
%
In another direction systems such as
\href{http://polymathprojects.org/}{polymath} and
\href{mathoverflow.net}{MathOverflow} show the interest among
mathematicians in exploring new forms of collaboration, when the tools
are well-designed and the balance of effort and reward is correct.
