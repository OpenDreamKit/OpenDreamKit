\documentclass[noworkareas,deliverables,compactht,keys]{euproposal}
...
\item \label{objective:community}Community building
  ...
  \TOWRITE{NT/...}{objective:community: expand and write detailed description}
...
\item \label{objective:data}Identify and extend ontologies and standards to
  ...
  \TOWRITE{POD}{write detailed description of Objective Data}
...
\TOWRITE{NT}{objective:community: detailed description}
...
The work plan is broken down into \pdatacount{wp} workpackages as shown in
...
the various tasks for these worka packages, including inter-task dependencies.
...
\item \label{pythran} Lead developers of Pythran and experts in
  numerical code optimization/parallelisation (Logilab, Grenoble)
...
\TODO{Linbox: recruitement of previous ANR developper}
