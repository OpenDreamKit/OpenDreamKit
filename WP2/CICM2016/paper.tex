...
\author{Nicolas M. Thi\'ery\inst{1} Michael Kohlhase\inst{2}\\
  Paul-Olivier Dehaye\inst{3} Alexander Konovalov\inst{4} Samuel Lelièvre\inst{1} }
\institute{
...
\begin{abstract}
  ...
  software systems, and in particular popular tools such as LinBox, MPIR, SageMath, GAP,
  Pari/GP, LMFDB, Singular, MathHub, and the IPython/Jupyter interactive computing
  environment. From that ecosystem, \ODK will deliver a flexible toolkit enabling research
