...
deliverables~\delivref{component-architecture}{sage-repository}
and~\delivref{component-architecture}{sage-distribution}. Because of
...
deliverables~\delivref{component-architecture}{virtual-machines}
and~\delivref{component-architecture}{portability-cygwin}.
...
The goal of \delivref{dissem}{ils-tool} is to provide a (open source)
...
\item \textbf{Accessibility}. As previously mentioned, the cloud based
  ...
  \delivref{component-architecture}{smc-documentation}.
