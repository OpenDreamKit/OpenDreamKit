...
\input{events/2016-08-SD75}

\subsection{Training activities for Sage in developing country}
~

As open-source software developers, we wish our products
to be accessible to the most people. Even though we offer
 a free access, in many 
developing countries, there is still a technical gap that 
often prevent school and researchers to benefice from our softwares.
This is why we believe it is the role of OpenDreamKit to foster 
a wider community that does not leave part of the world behind. In 
this section, we describe training activities that have been conducted 
through OpenDreamKit in this regard.

Events \ref{2015DIMACOS, 2016HADAT, 2016CATN} are part of a long term
plan from Adrien Boussicault (Bordaux university) to create an active 
and independent Sage community in the Mediterranean area by repeated 
events and the creation of a local team. We also included Event \ref{2016ECCO}
which took place in Colombia and was a positive example of the inclusivity 
and openness spirit we want to achieve.


\input{events/2015-11-DIMACOS}

\input{events/2016-03-HADAT}

\input{events/2016-03-CATN}
...
to reach potential end users, form connection and stay aware 
...
These past year, OpenDreamKit has been organizing or co-organizing
