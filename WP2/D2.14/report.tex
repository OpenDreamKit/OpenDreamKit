...
There are many other interesting solutions that can be used. One of
this is \texttt{jupyter-book}
project\footnote{\url{https://github.com/jupyter/jupyter-book}}.
It allows you to create content using markup and \Jupyter notebooks.
It converts these into Jekyll pages.  Just like the \texttt{Sphinx}
system allows more control over the output generated, but requires
...
We have also demonstrated that the approach in \delivref{dissem}{ibook1} and
