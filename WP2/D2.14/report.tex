...
textbooks, both from the learner and author perspectives (Sec.~\ref{...}).
...
\TODO{Decide whether the following paragraphs should be here or in the
  ``reflecting section of`` D2.17 Introduce ODK to researchers and
  teachers}
...
In \longdelivref{dissem}{ibook1}, we explored authoring the books
...
\TODO{Merge the three upcoming paragraphs with the next ones}
