...
\TODO{Describe the content of the report: In section ... we ... in
  section ... we ...; detail a bit the description of the
  ``implementation'' section; in particular mention that best
  practices and sustainability are discussed.}
...
\TODO{Original workflow?}

\TODO{a bit of mix between past and present tense}
...
\TODO{mention that this is likely to get better very soon as those
  packages mature and the transition to JupyterLab happens}
