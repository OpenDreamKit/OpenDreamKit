...
but also Software Carpentry lessons, course notes, etc.
...
Here is such an
\href{https://github.com/nheir/sage-combinat-widgets/blob/example_parapolyomino/examples/ParalleloPolyomino.ipynb}{\emph{example
notebook for a parallelogram polyomino}} with following resulting
\emph{interactive widget} (see figure next page .. FIXME)
...
All technologies developed in OpenDreamKit are based on open, standard,
and modern web technologies, which should make it straightforward to
integrate in any larger infrastructure or infrastructure federation, and
