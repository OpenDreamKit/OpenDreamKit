...
\item embedding \Sage code as live cells which can be edited, executed
  ...
  \TODO{NT: after the report, we should discuss this! I wrote a similar
    ...
    \url{https://more-sagemath-tutorials.readthedocs.io/en/latest/agregation-option-calcul-formel/multiplications_rapides.html#agregation-multiplications-rapides}.}
