...
% Not sure what this means. Translation etc.? Diversity initiatives?
...
Jupyter notebooks are a vehicle for the dissemination of computational methods
and results, combining a narrative description of the steps taken with
executable code which may be used to reproduce the results. Providing services
to host and share notebooks will improve dissemination at all scales, making it
easier for anyone interested in a result to re-run the analysis. It also makes
published results more valuable, as they can be used directly as a starting
