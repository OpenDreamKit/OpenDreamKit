...
particular documentation and trivial code changes.  Non trivial
code changes or additions requires to check that the updated code builds successfully and passes the test
...
The work done in \delivref{component-architecture}{multiplatform-buildbot} will make it easier to (near) instantly launch a Sage
