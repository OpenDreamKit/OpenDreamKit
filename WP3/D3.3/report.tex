...
% TODO: Fix travis tests and update READMEs by newer versions
...
\item from SageMath to GAP (Appendix \ref{SageMath-to-GAP}),
...
Python application shown in Appendices \ref{python2-to-GAP},
\ref{python3-to-GAP}, \ref{SageMath-to-GAP} and 
\ref{Python3sympy-to-GAP-Singular}, and a GAP client calling
NumPy Python 3 library in Appendix \ref{GAP-to-Python3numpy},
we also demonstrate several use cases for GAP SCSCP package 
