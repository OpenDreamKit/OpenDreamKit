...
difficulties \TODO{include this statement if correct-- \Sage already
  expose parallelism elsewhere in \Singular--}, we decided that it
...
see~\delivref{hpc}{GAP-HPC-report}.
