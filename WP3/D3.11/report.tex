...
in tickets
\begin{itemize}
\item  \url{https://trac.sagemath.org/ticket/27444} and
\item  \url{https://trac.sagemath.org/ticket/26932}.
\end{itemize}
...
\begin{figure}[htb]
  \begin{center}
    ...
    \caption{Parallel computation time for some finite field linear algebra operations in SageMath}
  \end{center}
\end{figure}
\begin{figure}[htb]
  \begin{center}
