...
\begin{minipage}{.58\textwidth}{\Huge OpenDreamKit (ODK) Glossary}\end{minipage}\begin{minipage}{.3\textwidth}\includegraphics[scale=0.14]{logos/odk.png}\hspace{.2\textwidth}\includegraphics[scale=0.08]{logos/europe.png}\end{minipage}\vspace{.2cm}%
...
{\large Cilk} &
\begin{tabular}{@{}p{.77\textwidth}@{}}
Programming language for multithread parallel computing\end{tabular}
\\\hline
{\large Conda} & 
\begin{tabular}{@{}p{.77\textwidth}@{}}
...
\\ \url{https://www.egi.eu/}\end{tabular}
\\\hline
EOSC &
\begin{tabular}{@{}p{.77\textwidth}@{}}
...
\begin{tabular}{@{}p{.77\textwidth}@{}}
L-functions and Modular Forms Database: number theory collaborative knowledge
...
{\large MPI} &
\begin{tabular}{@{}p{.77\textwidth}@{}}
Message Passing Interface - standard for parallel computing architecture.
\end{tabular}
\\\hline
{\large MPIR} & 
\begin{tabular}{@{}p{.77\textwidth}@{}}
...
\\ \url{https://pypi.org/}\end{tabular}
\\\hline
...
%{\large SGE} & 
%\begin{tabular}{@{}p{.77\textwidth}@{}}
%Sun Grid Engine and derivatives: distributed resource manager for HPC clusters
