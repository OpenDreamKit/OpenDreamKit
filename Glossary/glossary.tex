...
{\large \textbf{IPython}}
\\\includegraphics[scale=0.05]{logos/copie.png}
\end{minipage}&
\begin{tabular}{p{.7\textwidth}}
...
\begin{minipage}{.2\textwidth}
{\large \textbf{MathHub}}
\\\includegraphics[scale=0.05]{logos/mathHubLogo.png}
\end{minipage}&
\begin{tabular}{p{.7\textwidth}}
...
\begin{tabular}{p{.7\textwidth}}
ecosystem of scientific Python packages (scipy, numpy, IPython, sympy, matplotlib, pandas)
