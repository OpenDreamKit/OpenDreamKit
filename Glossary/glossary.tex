...
\begin{minipage}{.52\textwidth}{\Huge OpenDreamKit Glossary}\end{minipage}\begin{minipage}{.3\textwidth}\includegraphics[scale=0.14]{logos/odk.png}\hspace{.2\textwidth}\includegraphics[scale=0.08]{logos/europe.png}\end{minipage}\vspace{.4cm}
