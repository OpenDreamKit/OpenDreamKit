...
\begin{minipage}{.55\textwidth}{\Huge OpenDreamKit Glossary}\end{minipage}\hspace{.03\textwidth}\begin{minipage}{.3\textwidth}\includegraphics[scale=0.12]{logos/odk.png}\hspace{.18\textwidth}\includegraphics[scale=0.06]{logos/europe.png}\end{minipage}\vspace{.7cm}
