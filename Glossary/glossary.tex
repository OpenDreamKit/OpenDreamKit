...
\end{minipage}&
\begin{tabular}{p{.7\textwidth}}
IPython is a command shell for interactive computing, mostly Python
...
{\large \textbf{MMT}} & 
\begin{tabular}{p{.7\textwidth}}
(Meta-Meta-Tool) a framework used in OpenDreamKit for modular representation of mathematical content
\end{tabular}
\\\hline
\end{tabular}
\end{minipage}
