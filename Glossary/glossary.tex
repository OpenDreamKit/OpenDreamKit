...
\begin{minipage}{.52\textwidth}{\Huge OpenDreamKit Glossary}\end{minipage}\begin{minipage}{.3\textwidth}\includegraphics[scale=0.14]{logos/odk.png}\hspace{.2\textwidth}\includegraphics[scale=0.08]{logos/europe.png}\end{minipage}\vspace{.3cm}
...
\end{minipage}&
\begin{tabular}{p{.7\textwidth}}
web-application for repository management based on git
...
\begin{minipage}{.15\textwidth}
{\large Pythran}
\\\includegraphics[scale=0.55]{logos/pythran-logo-small.png}
\end{minipage}&
\begin{tabular}{p{.7\textwidth}}
