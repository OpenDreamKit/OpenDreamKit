...
\begin{supertabular}{|m{.47\textwidth}m{.47\textwidth}|}\hline
  ...
  \item By the end of the project, the scientific community in mathematics using the tool
    will increase by X\%
  \item The scientific community in other disciplines (e.g. biology, physics, etc.) using the tool
    will increase by X\%
...
and  re-use of mathematical data for further calculations and thus making
