...
\tablehead{}
\begin{supertabular}{|m{7.924cm}m{7.9420004cm}|}
\hline
\multicolumn{2}{|m{16.065998cm}|}{More effective collaborations between
researchers}\\\hline
\multicolumn{1}{|m{7.924cm}|}{\TheProject will strengthen collaborations
between European scientific community in different branches of
mathematics, through a development of the common e-infrastracture by
bringing together software and databases previously separated,  and
build links with scientific communities in other disciplines (biology,
physics, astronomy) that will use this e-infrastructure. The scientific
community will considerably increase, by integrating new actors both
from academic and non academic sector.} &
Key performance indicators :

\begin{itemize}
\item By the end of the project, the scientific community in mathematics
using the tool will increase by X \%\item The scientific community in
other disciplines (biology, physics) using the tool will increase by
X\%\item Number of enterprises using the tool will increase by
X\%\end{itemize}
\\\hline
\multicolumn{2}{|m{16.065998cm}|}{Higher efficiency and creativity in
research, higher productivity of researchers thanks to reliable and
easy access to discovery, access and re-use of data}\\\hline
\multicolumn{1}{|m{7.924cm}|}{The development of a new integrated tool,
replacing 3 previously separated tools, a possibility of real time data
sharing, data re-use and simultaneous working will allow an important
gain in time and in efficiency, and, by consequence, higher
productivity of researchers. Moreover, the exchange of best practice
(such as regular audit of codes) will have an important impact on the
quality of the research. Finally, the unique tool will allow
considerably reducing the costs of further research.} &
Key performance indicators :

\begin{itemize}
\item The e-infrastructure developed by the end of the project will help
reducing time of research by X\%\item The productivity of researchers
will increase by X\%\item Thank to best practice exchange, the quality
of reseach will considerably increase and number of errors will be
reduced\item Better traceability of research \item Costs for research
considerably reduced\end{itemize}
\\\hline
\multicolumn{2}{|m{16.065998cm}|}{Accelerated innovation in research via
an integrated access to digital research resources, tools and services
across disciplines and user communities}\\\hline
\multicolumn{1}{|m{7.924cm}|}{An integrated access to digital research
...
industrial actors in several disciplines\end{itemize}
\\\hline
\multicolumn{2}{|m{16.065998cm}|}{Researchers able to process structured
and qualitative data in virtual and/or ubiquitous workspaces}\\\hline
\multicolumn{1}{|m{7.924cm}|}{\TheProject will enable researchers to process
...
\multicolumn{2}{|m{16.065998cm}|}{Increased take-up of collaborative
research and data sharing by new disciplines, research communities and
institutions}\\\hline
\multicolumn{1}{|m{7.924cm}|}{The project will clearly enhance a take-up
...
With this model, the vendor is required to make the new code available
...
data be exploited and/or shared/made accessible for verificationand
