...
essential to its use in demanding large-scale computations. This section
updates and extends the technical description provided in D3.8 (Month 36),
focussing on the impact that the associated technical advocacy, training and support,
carried out through \GAP online support channels, as well 
as through development workshops reported in WP2 deliverables D2.2,
D2.11 and D2.15, had on the developers and package authors.
