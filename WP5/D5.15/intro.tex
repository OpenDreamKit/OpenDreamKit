...
\HPCGAP and {\sf MeatAxe64} and maintenance of our support for distributed
...
systems: \HPCGAP and {\sf MeatAxe64}. Section  \ref{sec:core-gap}
reports a wide range of relevant general developments in the core \GAP
system, highlighting {\sf libGAP} which gives a much faster and
