...
\href{https://www.gap-system.org/Doc/Bib/bib.html}{more than 3000
  research publications}. It is also widely used in teaching.
...
\HPCGAP and \software{MeatAxe64} and maintenance of our support for distributed
...
systems: \HPCGAP and \software{MeatAxe64}. Section  \ref{sec:core-gap}
reports a wide range of relevant general developments in the core \GAP
system, highlighting \software{libGAP} which gives a much faster and
