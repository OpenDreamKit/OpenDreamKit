...
This report describes the work undertaken in connection with Task~5.2,
  a wide range of developments within the \GAP system to meet the general
objective of workpackage 5 (``improve the performance of the computational
components of \ODK''). We have worked on
...
systems, \TODO{We say nothing about clusters and cloud computing. Say
  something or delete this} clusters and cloud computing. We have also made
fundamental performance improvements and improvements to our tools,
  processes and to the programming language that benefit all \GAP users.
...
using the SCSCP package \cite{SCSCP} \TODO{Is there any actual SCSCP activity we can
point to, even if it's just a bugfix release or some new demos?}.
