...
\comment{I wonder if we should use ODK month numbers as well as, or
  ...
  USTAN is St Andrews, and when month 0 was. AK: Dome. Footnote below
  and USTAN introduced on the front page}
...
\TODO{We should be consistent in terminology -- we {\bf publish releases}
