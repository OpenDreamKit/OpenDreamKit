...
version of \GAP, instead of checking them in advance. \GAP developers
...
dissemination.  The package fulfills all the requirements in the first list, as
well as most of (TODO: all) the requirements in the second, as summarised in
...
\begin{table}[h]
  ...
  \begin{tabular}{|p{5.1cm}|c|p{9.5cm}|}\hline
    ...
    Live interactive online demos & & TODO \\ \hline
