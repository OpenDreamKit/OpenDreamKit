...
\TODO{Mention that it uses ~/.gap/pkg ?  Or is that too technical?}
...
minimal size, containing only the four required packages and {\sf
  PackageManager} itself, installing others only as required.  Furthermore, it
...
with \cocalc, and can be seen as a good precedent for interaction with other
systems.
