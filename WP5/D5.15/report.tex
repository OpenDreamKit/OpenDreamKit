...
\TODO{get HMC in earlier and mention that other deliverables that \GAP
...
in various combinations of operating systems (Linux, OS X, Windows)
...
create the next release branch for things to stabilize and let package
authors to test it and if need be adapt their packages.

\GAP distribution is provided in several archive formats for Linux and OS X,
