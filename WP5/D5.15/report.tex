...
The \GAP test
suite for the core system consists of a total of 706 test files at the time of writing
totalling over $60\,000$ lines,
as well as of the tests that check the correctness of manual examples
\comment{again, numbers?}. In addition many packages have large test suites.
...
quality and their suggested changes are actually being tested. \TODO{Can we back this claim up with numbers}
