\section{Improvements to \GAP Package Tools}\label{sec:package-tools}
...
\begin{table}[h]
  ...
  \begin{tabular}{|p{5.1cm}|c|p{9.5cm}|}\hline
    ...
    Workshop & \checkmark & \multirow{2}{9.6cm}{Demos in \textit{CIRCA Seminar} (USTAN, Mar 2019) and \textit{Workshop on Mathematical Data} (Cernay, Aug 2019)} \\ \cline{1-2}
