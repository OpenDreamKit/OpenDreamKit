...
{\sf PackageManager} is a \GAP package itself, and is utilised in the
...
There are no currentplans to stop distributing
deposited packages with the \GAP archive by default, but the
possibility of distribut a much smaller archive, containing only a few
