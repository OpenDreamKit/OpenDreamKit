...
memory paralellisation, relevant to many of our users given that even
...
unique to \GAP.  What does present a serious challenges for \HPCGAP, however, is that the \GAP
