...
based on the {\sf C-MeatAxe} (the name ``MeatAxe'' is derived from the
...
of a new C and assembler library, called {\sf MeatAxe64}, which takes
...
{\sf MeatAxe64} \GAP package \cite{meataxe64}) currently in beta-testing,
and are in the process of revising higher levels of the software stack
to make best use of it.

The {\sf MeatAxe64} C library is multi-threaded using a bespoke and
...
speedups obtained by {\sf MeatAxe64} compared to our existing code.  The
...
\begin{center}
  \begin{longtable}{|c|c|c|c|c|}
    \caption[]{Performance of {\sf MeatAxe64} on one core}\label{fig:matmult:mtx64}\\
    \hline
    $q$&Dim.&cpu (s)&wall (s) &throughput\\
    &&&&(Gfop/s)\\
    \hline
    \endfirsthead
    \caption[]{Performance of {\sf MeatAxe64} on one core}\\
    \hline
    $q$&Dim.&cpu (s)&wall (s) &throughput\\
    &&&&(Gfop/s)\\
    \hline
...
\begin{center}
  \begin{longtable}{|c|c|c|c|c|}
    \caption[]{Performance of {\sf MeatAxe64} on 64 cores}\label{fig:matmult:par}\\
    \hline
    $q$&Dim.&cpu (s)&wall (s) &throughput\\
    &&&&(Gfop/s)\\
    \hline
    \endfirsthead
    \caption[]{Performance of {\sf MeatAxe64} on 64 cores}\\
    \hline
    $q$&Dim.&cpu (s)&wall (s) &throughput\\
    &&&&(Gfop/s)\\
    \hline
