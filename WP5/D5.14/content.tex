...
\begin{algorithm}[htb]
  ...
  \begin{algorithmic}[1]
    ...
    \State $\vect{c}^{(i)}  \leftarrow \mat{B_i} \vect{\rho}^{(i)} \mod p_i$
...
\end{center}
\caption{Sequential RNS Dixon.}\label{fig:rnsdixon_seqprimescount}
\end{figure}
\begin{figure}[htb]
\begin{center}
...
\end{center}
\caption{Parallel RNS Dixon.}\label{fig:rnsdixon_parallel}
\end{figure}

\begin{figure}[htb]
\begin{center}
  \includegraphics[width=.8\textwidth]{Pictures/RNSDixon/parallel-detailed_100n_40b}
  \includegraphics[width=.8\textwidth]{Pictures/RNSDixon/parallel-detailed_500n_400b}
\end{center}
\caption{Balance between initialization and lifting phases. In each cluster, left column correspond to a sequential run,
and right column to a run with 16 cores}\label{fig:rnsdixon_parallel}
\end{figure}

\begin{figure}[htb]
\begin{center}
  \includegraphics[width=.9\textwidth]{Pictures/RNSDixon/parallel-threads}
\end{center}
\caption{Parallel RNS Dixon.}\label{fig:rnsdixon_parallel}
\end{figure}
