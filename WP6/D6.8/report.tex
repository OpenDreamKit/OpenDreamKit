...
\item The MitM ontology is the centerpiece of this deliverable: it provides formalization of mathematical background theories relevant in OpenDreamKit.
...
\ednote{@MK: I couldn't figure out how to scale this down. (tikz scale does not work.)}

As an example, Figure~\ref{fig:cgtontology} sketches the alignments between the computational group theory ontology from above and the constructors and operations of \GAP.
