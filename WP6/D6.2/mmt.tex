...
\ednote{Paragraphs don't appear correctly, it should be made bold. Whatever is done with paragraphs, should be checked with the Appendix as we have our own format there}
\paragraph{Theories}
