...
the cache was created.  This can be done directly in Python -- a memoised
...
two-sentence introduction, guide to installation, and small number of examples
...
themselves, producing an interactivity which may encourage the reader to
