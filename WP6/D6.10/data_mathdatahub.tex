...
The interface is shown in Figure~\ref{fig:joe}, it's structure in Figure~\ref{fig:dmhstruct}. 
...
These are composed of several datasets and will introduce support for databases such as the OEIS\cite{Sloane:OEIS} or House of Graphs\cite{HOG}.
