...
\ednote{TW@MK: Do we want to give a short overview here or leave this sentence as is?}
...
This works takes the form of several components, each of which can deployed independently using Docker \ednote{TW: Cite Docker and reference appropropriate WP here}.
...
\begin{oldpart}{}
\ednote{TW@MK: Not sure if we want this section at all, or leave it for elsewhere in the document}
