...
\ednote{@MK: The caption of Figure~\ref{fig:mitm1} is in the totally wrong place for me, but I don't see what the problem is.}
...
Based on a survey of practical needs, we compiled such a set in Deliverable 6.8.\ednote{@MK: make this a proper reference}

Moreover, we need an open-ended set of types for mathematical structures such as fields and rings.
Here we have developed a novel type constructor \ednote{@MK: cite Theories as Types paper} that turns any MMT theory into the corresponding dependent record type.
