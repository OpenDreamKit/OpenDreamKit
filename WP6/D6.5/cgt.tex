...
The left box in Figure \ref{fig:cgtontology} shows the levels and their relation to the constructors and operations of \GAP. \ednote{FR@all: This section is incomplete - it lacks the description rings etc. This must be fixed but cannot be fixed on short notice. So I'm carefully phrasing this paragraph to work around it.}
