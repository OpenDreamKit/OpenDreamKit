...
\ednote{MK@JC: you may want to say something about the change to Postgres and that the API stays the same here.}
...
\begin{oldpart}{MK@JC: you may want to reformulate this paragraph. Here would also be the right place to describe the development of the inventory and how this was triggered by ODK and helpful in the migration to Postgres. ... } \lmfdb's technical realization does not require formalizing the schema of each table. 
