...
Here is the corresponding OpenMath syntax tree in Python and XML respectively:
\begin{lstlisting}
OMApplication(
...
This approach has the additional advantage of potentially benefiting from optimizations implemented in \Python's serialization, like structure sharing for identical subexpressions.
