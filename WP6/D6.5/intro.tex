...
In the second one, we show the integration of the mathematical knowledge base \LMFDB into MitM-based computation.\ednote{MK: preview the contribution of the MitM paradigm here.}
