...
\begin{abstract}
  ...
  instantiates the MitM paradigm the systems \GAP, \Sage, \LMFDB, and \Singular\ednote{MK:
    Pari/GP as well?} to perform computation in group, ring, and number theory.
