...
A programmatic interface, if it exists at all, is usually system specific, meaning that to use it mathematicians need to be familiar both with the mathematical background and internal structure of the system in question.  
...
We then continue in Section~\ref{sec:sota} by giving an example of a state-of-the-art Mathematical Database along with its' interface by discussing \lmfdb. 
