...
\inlinecode{true} as \inlinecode{1}, and \inlinecode{false} as \inlinecode{0}. This
information can then be used to make the query \inlinecode{?ab=1} to find all Abelian
transitive\ednote{MK; where does this come from?} groups.
