...
\end{figure}
The \lmfdb API can be found at
\url{http://www.lmfdb.org/api/transitivegroups/groups/}\ednote{Proper citation} and has
two basic modes.
...
\identifier{ab} key\ednote{MK@TW: this (i.e. ``ab'') should be visible in Figure 3!!!!! -- TW: it is literally the first property of every curve; also see api breakage comments}
...
\url{http://www.lmfdb.org/api/transitivegroups/groups/?ab=1}. This finds all abelian transitive \ednote{TW; Broken because of lmfdb}
groups.
...
%  LocalWords:  centering summarize sec:mmtmitm
