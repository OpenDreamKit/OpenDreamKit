...
\section{\MWS Corpora: arXiv, ZBMath, Mizar}\label{arxiv}

The \MWS system has been used on various corpora. 
...
We have converted the Mizar Mathematiacl Library~\cite{MizarKB:on} to the OMDoc/MMT format
...
appliccable theorems, e.g. we can issue queries like formula query:
