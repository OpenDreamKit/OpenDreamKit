...
\begin{abstract}
  ...
  for mathematical formulae encoded in Content MathML.  We want to use it for searching
  notebooks, active documents and the Math-in-the-Middle Ontology in the OpenDreamKit VRE.
  

  MathWebSearch is a complete system capable of crawling, indexing, and querying
