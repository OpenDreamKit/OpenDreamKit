...
\author{Mihnea Iancu\inst{2} Paul-Olivier Dehaye\inst{1} Michael Kohlhase\inst{2} Dennis
  M\"uller\inst{2} Alexander Konovalov\inst{3} Samuel Lelièvre\inst{4} Markus
  Pfeiffer\inst{3} Florian Rabe\inst{2} Nicolas M. Thiéry\inst{4} Tom Wiesing\inst{2}}
