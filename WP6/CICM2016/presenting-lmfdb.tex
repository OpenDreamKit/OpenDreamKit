...
\ednote{R3: "the concept of transclusion" - some readers might not be familiar; a pointer 
to the LMFDB implementation of this protocol would be useful}
...
\ednote{R3: "STEX flexiformalization of an LMFDB knowl" - pointer to the original for comparison?}
