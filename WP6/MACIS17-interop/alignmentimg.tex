...
\begin{tikzpicture}
\node (mitm) at (-3,8.5) {\emph{Level}}; 
\node (a) at (-3,7.5) {\emph{abstract}}; 
\node (b) at (-3,6) {\emph{repn.}}; 
\node (c) at (-3,4.5) {\emph{impl.}}; 
\node (d) at (-3,3) {\emph{concrete}}; 
...
\draw[->] (isgrp) -- (isfpgrp);
 ...
 \node[draw,thick,fit=(isgrp) (ispermgrp) (ismatgrp) (isfpgrp) (empty),
