...
The \Sage community already values serialization by construction as superior because it is usually more concise and more robust under changes to \Sage.
Moreover, improved serialization support is already \Sage community goal in order to enable communication between parallel processes, build databases, etc.
Therefore, we expect, independent of the purposes of this paper, our serialization work to be taken up and extended by the community.
