...
each of the systems $A$ to $H$, we generate a theory graph \textbf{API Content
  ...
  ontology.}  in OMDoc/MMT which is aligned with the corresponding symbols in the MitM
ontology. As the API CDs and the MitM Ontology are both in OMDoc/MMT -- inside the cloud
in Figure~\ref{fig:mitm} -- we can make use of \textbf{OMDoc/MMT
