...
% \item \MMT interprets the inner term \lstinline|scscp(lmfdb,query("transitivegroup"))|,
% translates it into a \LMFDB query $Q'$ in LMFDB dialect and sends it to the \LMFDB \SCSCP server via \SCSCP. 
...
%  mitmcomm MueRoYuRa:abtafs17 Rabe:MAGMS13,uniformal:on inparaenum \Sagey lstlisting
%  scscp mmt,is_cyclic scscp lmfdb mmt,query transitivegroup lstinline gap,is_cyclic,scscp
%  lmfdb,query synthesizes mathescape {\Sage} ify
