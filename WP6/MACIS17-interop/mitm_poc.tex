...
written in Python and uses the \lstinline|scscp and \lstinline|PySingular| python
modules. The only function exposed by this server is the evaluation of equality of two
