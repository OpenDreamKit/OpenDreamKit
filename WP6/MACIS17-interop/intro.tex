...
In this paper we instantiate the MitM paradigm with a concrete domain development and evaluate it on a distributed computing GAP, SageMath and Singular.
...
%  LocalWords:  sec:intro Sloane:oeis12,oeis mathbb Cremona:LMFDB16,lmfdb:on GAP:on SageMath:on singular:on DehKohKon:iop16 emph sec:mitm sec:cgt sec:apit sec:mitm_poc sec:concl MitM-based
