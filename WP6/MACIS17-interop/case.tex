...
\GAP.
And thus the 1800-line\ednote{MP@MK: Radiroot relies on Alnuth (another 3500
  lines of GAP code + pari code), but both packages of course provide more
  functionality than just galois groups. Regardless of that, it is much easier
  to write a couple of method installations than a full GAP package}
