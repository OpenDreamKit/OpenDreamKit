...
\TODO{USTAN}{Please complete section and table. See ``Guidelines for completion of partner specific resource summary'' in latex comments in H2020/resources.tex.}
% See guidance above ("Guidelines for completion of partner specific resource summary") for what to add here.
...
\textbf{Publication charges} & 4,000 & Open access publication charges (see \ref{sect:budget-outreach-publication-charges})\\\hline
\textbf{Equipment} & 15,000 & Compute servers for tasks XXX \\\hline    %\taskref{WP-ID}{TASK-ID}

\textbf{Other goods and services} & 11,100 & Workshops \\\hline   %\taskref{WP-ID}{TASK-ID} \delivref{WP-ID}{DELIV-ID}
\textbf{Audit} & 4,300 & Audit cost \\\hline
\textbf{Total} & 111,200\\\cline{1-2}
\end{tabular}
