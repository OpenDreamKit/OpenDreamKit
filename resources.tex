...
\TOWRITE{US}{Please complete section and table. See ``Guidelines for completion of partner specific resource summary'' in latex comments in H2020/resources.tex.}
% See guidance above ("Guidelines for completion of partner specific resource summary") for what to add here.
