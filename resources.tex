...
and Dr. habil Florian Rabe (theorertical foundations of triform theories). Furthermore, we
request 24 PM each for a research programmer (Dr. Christian Maeder) and a junior
researchers (Mihnea Iancu M.Sc.). The first will do much of the actualy system development
...
%  LocalWords:  data-findstat lmfmod lmfval Organisation Jupyter
