\TOWRITE{DP}{Proofread 3.4 pass 1}
\TOWRITE{ALL}{Proofread 3.4 pass 2}

\TOWRITE{DP}{Add acronym in the upper left cell of each table}
...
\COMMENT{The audit costs are *not* direct costs and should not be
  listed there! If you haven't entered them, just delete the
  corresponding line.}
\TOWRITE{ES/NT}{Remove the remaining audit costs lines this Tuesday
  with Eugenia}
...
\TOWRITE{Logilab}{Please complete section and table. See ``Guidelines for completion of partner specific resource summary'' in latex comments in H2020/resources.tex.}
...
From his total involevemt, Pasechnik will take 4 person months to work on WP3.
...
Implementation \taskref{hpc}{hpc-jupyter}. The other for a period of 36
months, with appointment at month 6, whose focus will be on user
...
Sheffield will host one of the project main workshops (15,000) and
will also host two workshops on machine learning and data science with
\TheProject. We also request equipment for workshop recording at
2,000, and funding for a large touch screen for live notebook posters
(\delivref{social-aspects}{social-poster}) at 5,000. For the researchers we request screens and computers (3,000).
% See guidance above ("Guidelines for completion of partner specific resource summary") for what to add here.
...
\textbf{Publication charges} & 4,000 & Open access publication charges (see \ref{sect:budget-outreach-publication-charges})\\\hline
\textbf{Equipment} & 10,000 &  \\\hline    %\taskref{WP-ID}{TASK-ID}

\textbf{Other goods and services} & 20,000 & Workshops \\\hline   %\taskref{WP-ID}{TASK-ID} \delivref{WP-ID}{DELIV-ID}
\textbf{Other goods and services} & 5,000 & HPC Compute Time \\\hline   %\taskref{WP-ID}{TASK-ID} \delivref{WP-ID}{DELIV-ID}
\textbf{Audit} & ?,??? & Audit cost \\\hline
\textbf{Total} & 97,200 + Audit\\\cline{1-2}
\end{tabular}
...
\TOWRITE{JacU}{Please complete section and table. See ``Guidelines for completion of partner specific resource summary'' in latex comments in H2020/resources.tex.}
% See guidance above ("Guidelines for completion of partner specific resource summary") for what to add here.
...
\TOWRITE{UK}{Please complete section and table. See ``Guidelines for completion of partner specific resource summary'' in latex comments in H2020/resources.tex.}
% See guidance above ("Guidelines for completion of partner specific resource summary") for what to add here.
...
University of Silesia will include three people in the project and their
involvement will  12 PM each. Jerzy Luczka and Jan Aksamit will work on interactive books
\taskref{dissem}{ibook} which will demonstrate the real case of using both
Structured Text and interactive features of the VRE. Marcin Kostur
will lead and contribute to this task as well.

University of Silesia will also actively contribute to the
\taskref{UI}{cfd-vis}. Based on its own package sailfish, which is a
high performance software in computational fluid dynamics, the
visualization module will be produced. The University of Silesia will
after initial research work done together with Simula (task leader)
will formulate and subcontract the development of software
visualization modules to the external company. The justification for
subcontracting is as follows. We have much experience as users of 3d
visualization software for fluid dynamics. However the expertise in
Computer Graphics (e.g. WebGL) is not enough at the Department of
Mathematics, Physics and Chemistry. Instead of building the expertise
it is financially more efficient to specify and outsource the
programming task and let professional to accomplish it.
...
\hline
\textbf{} & \textbf{Cost (\euro)} & \textbf{Justification} \\\hline
\textbf{Travel} & 17,500 & Travel (see \ref{sect:budget-details-travel})\\\hline
...
\textbf{Audit} & 0,000 & Audit cost \\\hline
\textbf{Total} & 57,500\\\cline{1-2}
\end{tabular}
...
He will lead tasks \taskref{dksbases}{data-assessment},  and assist for \taskref{dksbases}{data-design}, \taskref{dksbases}{data-triform}, \taskref{dksbases}{data-foundationCAS}, \taskref{dksbases}{data-findstat} and \taskref{dksbases}{data-LMFDB}. He is in charge of deliverables \delivref{dksbases}{conv},  \delivref{dksbases}{lmfmod} and finally \delivref{dksbases}{lmfval}.
...
\begin{table}[ht]\centering
  ...
  \TODO{This table is in the wrong place in the proposal - before workpackages, not after}
