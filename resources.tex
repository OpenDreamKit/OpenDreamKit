...
expect the investigator and the researcher together to do 4 one-week visits
...
\TOWRITE{ES/NT}{Remove the remaining audit costs lines this Tuesday
  with Eugenia}
\TOWRITE{ES/NT}{Edit the table to add a more specific justification
  (see guidelines ...)}
\TOWRITE{ES/NT}{Supress subcontracting from Silesia's table}
...
\site{UK}  requests 48 person months for a researcher to work on task ~\localtaskref{hpc}{singular},
12 person months for a researcher starting in month 0 to work on task ~\taskref{hpc}{mpir},
36 person months for another researcher starting in month 12 to work on  task~\taskref{hpc}{singular},
and 2 person months for the lead PI (Wolfram Decker).
...
\hline
\textbf{} & \textbf{Cost (\euro)} & \textbf{Justification} \\\hline
\textbf{Travel} & 81,200 & Travel (see \ref{sect:budget-details-travel})\\\hline
...
efficient to specify and outsource the programming task and let
professional to accomplish it.
