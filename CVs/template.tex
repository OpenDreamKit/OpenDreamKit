\begin{participant}[type=XXX,PM=YYY,salary=ZZZ]{First-name Last-name}

% type is one of "lead PI", "PI",  or "R". 
% YYY is a fair evaluation of the number of months you will be spending on this
