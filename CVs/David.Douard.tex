\begin{participant}[type=PI,PM=6,gender=male]{David Douard}
  holds a Master Degree from the Ecole Nationale Supérieure de Physique de
  Strasbourg and a PhD in computer science from Université Paris VI.
  ...
  \software{Python}, \software{GUI libraries (Tk, PyQt, wxPython)},
