...
\begin{frame}
  ...
  \begin{description}
    \item[From single purpose to general purpose:]
      \begin{itemize}
      \item  Early instances of HPC computer algebra: dedicated to a target
        application (breaking RSA, )
      \item Building a general purpose HPC component:
        \begin{itemize}
        \item challenging
        \item longer term viability
        \end{itemize}
      \end{itemize}
    \item[Risk of technology dependency]
      \begin{itemize}
      \item Cilk: from success to shut-down
      \item DSL for interchangeability and modularity
      \end{itemize}
      \end{description}
  \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
