...
\begin{frame}
  ...
  \begin{block}{Mathematical computing}
    ...
    %%   \begin{column}{.5\textwidth}
        ...
        \begin{itemize}
        \item $\Z, \Q, \Z/p\Z, \F_q$,
        \item Polynomials over $\Z, \Q, \Z/p\Z, \F_q$,
        \item Matrices over $\Z, \Q, \Z/p\Z, \F_q$,
        \item Matrices of polynomails over $\Z, \Q, \Z/p\Z, \F_q$,
        \item Graphs
        \end{itemize}
    %%   \end{column}
...
\begin{frame}
  \frametitle{High Performance Mathematical Computing}
  \begin{block} {Need for High performance}
