...
\item As suggested by the project officer, reduction of the number of
  ...
  \item Merged D7.1, D7.4, D7.7 (Reports on relevant research in
    ...
    VRE, parts I, II, III).
  \end{itemize}
\item Changes due to the 1st amendment of the Grant Agreement number 676541
 \begin{itemize}
 ...
 \item UGent added to the list of partners concerned by: T1.1, T1.2, T1.3, T2.3, T3.1, T3.2, T3.3, T3.6, T3.7, T4.1, T4.4, T4.5, T4.12
 ...
 \item Resources for UPSud were modified following the addition of UGent and the evolution of the distribution of WP
 \item Resources were allocated to UGent followint their addition to the consortium
 \item Resources allocated to JacobsUni were resfhuffled following the organisation of an extra workshop (their total budget was not changed)
