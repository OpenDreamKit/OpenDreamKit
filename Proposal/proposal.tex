...
\item Reduction of the number of deliverables by merging together
  related deliverables (typically removing intermediate check-points):
  \begin{itemize}
  \item Merged D3.1 into D3.9: One-click install Sage distribution for
    Windows with Cygwin.
  \item Merged D2.16 (Micromagnetic VRE code and documents source
    ...
    tutorial and documentation notebooks), D4.14 (Demonstrator online
    portal available) into a single deliverable D2.13 (Micromagnetic
    VRE completed and online).
  \item Merged D2.3, D2.15, D2.23 and D2.24 (Demonstrators: Problems
    in Physics with Sage, Computational Mathematics for Engineering).
  \item Merged D5.9 (Report on development of designs for the GAP
    ...
    D5.19 (final report and evaluation of the GAP developments).
  ...
  \item Merged D6.10 (Full-text search (Formulae + Keywords) over
    ...
    Modules).
    \item TODO: merges by Pierrick, Marcin, Luca, Dima, Viviane
  \end{itemize}
\end{enumerate}
\fi
