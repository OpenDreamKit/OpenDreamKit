...
\begin{verbatim}
  Removed duplicated deliverables:
  - 2.10 Course material on using OpenDreamKit in data science
  - 2.12, 2.13 indexing service
  - 2.20 Demonstrator: Interactive lecture notes and marking systems based on OpenDreamKit.

  Updated risk table (TODO: develop)

  WP2: Participation to the European E-Infrastructure concertation activities.
\end{verbatim}
\fi
