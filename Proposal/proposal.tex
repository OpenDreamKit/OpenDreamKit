...
\item In progress: reduction of the number of deliverables by removing
  unneeded intermediate check-points toward main deliverables;
  deliverable cross references may be temporarily inconsistent with
  that posted on the EU web site.
