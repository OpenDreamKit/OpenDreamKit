...
\begin{workpackage}[id=management,type=MGT,wphases=0-48!.2,swsites,
  ...
  UWRM=2, JURM=1, UKRM=2, USRM=2, ZHRM=1, SRRM=2, UGRM=1, FAURM=1] % Should be 1.5 for UG
\begin{wpobjectives}
...
\begin{task}[title=Project and financial management,
  ...
  partners={LL,UV,UJF,UB,UO,USH,USO,SA,UW,JU,UK,US,ZH,SR,UG,FAU},issue=14]
...
\begin{task}[title=Quality assurance and risk management,id=project-quality-management,
  wphases=6-48!.3,
  lead=PS,PM=15,partners={LL,UV,UJF,UB,UO,USH,USO,SA,UW,JU,UK,US,ZH,SR,UG,FAU},issue=15]
...
\begin{task}[title=Innovation management,wphases=6-48!.2,
  ...
  partners={LL,UV,UJF,UB,UO,USH,USO,SA,UW,JU,UK,US,ZH,SR,UG,FAU},issue=16] One of the
...
\end{wpdeliv}
\begin{wpdeliv}[due=18,miles=proto1,lead=PS,id=imp1,dissem=CO,nature=R,issue=20]
