...
\begin{workpackage}[id=management,type=MGT,wphases=0-48!.2,swsites,
  ...
  UWRM=2, JURM=2, UKRM=2, USRM=2, ZHRM=1, SRRM=2, UGRM=1] % Should be 1.5 for UG
\begin{wpobjectives}
...
\begin{task}[title=Project and financial management,
  ...
  partners={LL,UV,UJF,UB,UO,USH,USO,SA,UW,JU,UK,US,ZH,SR,UG}]
...
\begin{task}[title=Quality assurance and risk management,id=project-quality-management,
  wphases=6-48!.3,
  lead=PS,PM=15,partners={LL,UV,UJF,UB,UO,USH,USO,SA,UW,JU,UK,US,ZH,SR,UG}]
...
\begin{task}[title=Innovation management,wphases=6-48!.2,
  ...
  partners={LL,UV,UJF,UB,UO,USH,USO,SA,UW,JU,UK,US,ZH,SR,UG}] One of the
...
\begin{wpdelivs}
\begin{wpdeliv}[due=1,miles=startup,id=infrastructure,dissem=PU,nature=DEC,lead=PS]{Basic project infrastructure 
...
\begin{wpdeliv}[due=36,miles=community,lead=PS,
