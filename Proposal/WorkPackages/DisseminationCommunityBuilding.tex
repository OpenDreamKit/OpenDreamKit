...
\begin{task}[title=Reviewing emerging technologies, id=tech-review, lead=PS, partners={SA,USO,USH,US,UV,UB,SR},PM=10, wphases=0-48,issue=27]
...
\begin{task}[title=Introduce \TheProject to Researchers and Teachers, id=project-intro,lead=USH,wphases=6-44,PM=20,partners={USO}, issue=29]
...
\begin{task}[id=dissemination-of-oommf-nb-virtual-environment,
  ...
  lead=USO,PM=4,partners={SR,USH,PS},wphases=28-32,issue=30]
...
id=dissemination-of-oommf-nb-workshops,lead=USO,PM=6,wphases=18-44!0.23,issue=31] % funny ratio here, that's okay (HF)
...
id=ibook,lead=US,partners={USO},PM=42,wphases={0-46,40-46},issue=32]
...
\begin{wpdelivs}
  \begin{wpdeliv}[due=6,miles=startup,id=press-release-1,dissem=PU,nature=DEC,lead=PS,issue=34]{Starting press release}\end{wpdeliv}
  \begin{wpdeliv}[due=12,miles=startup,id=workshops-1,dissem=PU,nature=R,lead=PS,issue=42]{Community building: Impact of development workshops, dissemination and training activities, year 1}\end{wpdeliv}
%  \begin{wpdeliv}[due=12,miles=startup,id=ibook3a,dissem=PU,nature=DEM,lead=US]{Demonstrator: Problems in Physics with Sage v1} \end{wpdeliv}
  \begin{wpdeliv}[due=12,miles=startup,id=techno,dissem=PU,nature=R,lead=PS,issue=43]{Review on emerging technologies} \end{wpdeliv}
 \begin{wpdeliv}[due=18,miles=proto1,id=short-course,dissem=PU,nature=DEC,lead=USH,issue=44]{A short course for lecturers on using \TheProject for delivering mathematical education.}\end{wpdeliv}
  \begin{wpdeliv}[due=24,miles=proto1,id=datascience-course,dissem=PU,nature=DEC,lead=USH,issue=45]{Course material on using \TheProject in data science and education}\end{wpdeliv}
  \begin{wpdeliv}[due=24,miles=proto1,id=workshops-2,dissem=PU,nature=R,lead=PS,issue=46]{Community building: Impact of development workshops, dissemination and training activities, year 2}\end{wpdeliv}
...
% merged with ils-tool  \begin{wpdeliv}[due=24,miles=proto1,id=ils-service,dissem=PU,nature=DEM,lead=UV]{Community-curated indexing service for \TheProject} \end{wpdeliv}
  \begin{wpdeliv}[due=24,miles=proto1,id=ibook2,dissem=PU,nature=DEM,lead=US,issue=48]{Demonstrator: Linear Algebra - interactive book} \end{wpdeliv}
...
%  \begin{wpdeliv}[due=30,miles=community,id=ibook3b,dissem=PU,nature=DEM,lead=US]{Demonstrator: Problems in Physics with Sage v2} \end{wpdeliv}
  \begin{wpdeliv}[due=36,id=ibook1,miles=community,dissem=PU,nature=DEM,lead=US,issue=49]{Demonstrator: Nonlinear Processes in Biology  interactive book} \end{wpdeliv}
  \begin{wpdeliv}[due=36,id=lecture-notes,miles=community,dissem=PU,nature=DEM,lead=USH,issue=35]{Demonstrator: Interactive lecture notes and marking systems based on \TheProject}\end{wpdeliv}
  \begin{wpdeliv}[due=36,id=workshops-3,dissem=PU,miles=community,nature=R,lead=PS,issue=36]{Community building: Impact of development workshops, dissemination and training activities, year 3}\end{wpdeliv}
  \begin{wpdeliv}[due=44,miles=eval,id=notebook-repo,dissem=PU,nature=DEM,lead=USH,issue=37]{Demonstrator: Repository of interactive Notebooks in Machine Learning and Computational Biology based on \TheProject.}\end{wpdeliv}
  \begin{wpdeliv}[due=48,miles=eval,id=oommfnb-vre-deliver,dissem=PU,nature=OTHER,lead=USO,issue=38]{Micromagnetic VRE completed and online} \end{wpdeliv}
...
% Combine the above demonstrators into one Deliverable
  \begin{wpdeliv}[due=47,miles=eval,id=ibook3c,dissem=PU,nature=DEM,lead=US,issue=39]{Demonstrators: Problems in Physics with Sage, Computational Mathematics for Engineering} \end{wpdeliv}
