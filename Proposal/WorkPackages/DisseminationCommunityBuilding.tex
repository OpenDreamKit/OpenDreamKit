...
\begin{task}[title=Community Building: Development Workshops, lead=PS,PM=24, partners={UB,UK,SR,SA,USH,UG}, id=devel-workshops, wphases=0-48]
...
\begin{task}[title=Reviewing emerging technologies, id=tech-review, lead=PS, partners={SA,USO,USH,US,UV,UB,SR},PM=10, wphases=0-48]
...
\begin{task}[id=dissemination-of-oommf-nb-virtual-environment,
  ...
  lead=USO,PM=4,partners={SR,USH,PS},wphases=28-32]
...
id=dissemination-of-oommf-nb-workshops,lead=USO,PM=6,wphases=18-44!0.23] % funny ratio here, that's okay (HF)
...
id=ibook,lead=US,partners={USO},PM=42,wphases={0-46,40-46}]
