...
% Combine the above demonstrators into one Deliverable
  \begin{wpdeliv}[due=47,miles=eval,id=ibook3c,dissem=PU,nature=DEM,lead=US]{Demonstrators: Problems in Physics with Sage v3, Computational Mathematics for Engineering} \end{wpdeliv}
