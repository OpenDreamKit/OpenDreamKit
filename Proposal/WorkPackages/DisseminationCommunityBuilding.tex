...
%  \begin{wpdeliv}[due=12,miles=startup,id=ibook3a,dissem=PU,nature=DEM,lead=US]{Demonstrator: Problems in Physics with Sage v1} \end{wpdeliv}
 ...
 \begin{wpdeliv}[due=18,miles=proto1,id=short-course,dissem=PU,nature=DEC,lead=USH,issue=44, status=submitted]{A short course for lecturers on using \TheProject for delivering mathematical education.}\end{wpdeliv}
  ...
  This deliverable was merged in \localdelivref{IntroODK}.
  \end{wpdeliv}
...
%  \begin{wpdeliv}[due=30,miles=community,id=ibook3b,dissem=PU,nature=DEM,lead=US]{Demonstrator: Problems in Physics with Sage v2} \end{wpdeliv}
  ...
  \begin{wpdeliv}[due=36,id=lecture-notes,miles=community,dissem=PU,nature=DEM,lead=USH,issue=35]{Demonstrator: Interactive lecture notes and marking systems based on \TheProject}
This deliverable was merged in \localdelivref{IntroODK}.
  \end{wpdeliv}
  ...
  \begin{wpdeliv}[due=44,miles=eval,id=notebook-repo,dissem=PU,nature=DEM,lead=USH,issue=37]{Demonstrator: Repository of interactive Notebooks in Machine Learning and Computational Biology based on \TheProject.}
This deliverable was merged in \localdelivref{IntroODK}.
  \end{wpdeliv}
