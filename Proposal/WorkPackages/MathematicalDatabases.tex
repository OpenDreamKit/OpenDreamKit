...
\begin{wpdeliv}[id=mws,miles=startup,due=9,nature=OTHER,dissem=PU,lead=JU,issue=133, status=submitted]
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,miles=community,id=lfmverif,dissem=PU,nature=OTHER,lead=FAU,issue=142,status=canceled]
    {Curated Math-in-the-Middle Ontology covering exemplary parts of \LMFDB, OEIS,
      \FindStat, \GAP, \Sage knowledge bases.}
    merged into \localdelivref{mitmo}.
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,miles=community,id=mitmo,dissem=PU,nature=OTHER,lead=FAU]
...
\begin{wpdeliv}[due=42,miles=eval,id=persistent-memoization,dissem=PU,nature=OTHER,lead=SA,issue=143]
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[id=nbad-search,miles=eval,due=42,nature=OTHER,dissem=PU,lead=FAU,issue=134,status=canceled]
    {Full-Text Search from Notebooks/Active Documents Interface} 
    merged into \localdelivref{fulltextsearch}
  \end{wpdeliv}
  \begin{wpdeliv}[id=fulltextsearch,miles=eval,due=42,nature=OTHER,dissem=PU,lead=FAU]
