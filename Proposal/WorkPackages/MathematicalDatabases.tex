...
\begin{wpdeliv}[id=mws,miles=startup,due=9,nature=OTHER,dissem=PU,lead=JU,issue=133, status=delivered]
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=24,id=psfoundation,dissem=PU,nature=OTHER,lead=FAU,issue=139,miles=proto1]
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,id=lfmverif,dissem=PU,nature=OTHER,lead=FAU,issue=142,miles=dksbases-interop1]
...
\begin{wpdeliv}[due=42,miles=dksbases-interop2,id=persistent-memoization,dissem=PU,nature=OTHER,lead=SA,issue=143]
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[id=nbad-search,due=42,nature=OTHER,dissem=PU,lead=FAU,issue=134,miles=dksbases-interop2]
