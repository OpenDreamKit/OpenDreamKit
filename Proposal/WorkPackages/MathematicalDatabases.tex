...
\begin{wpdeliv}[id=mws,miles=startup,due=9,nature=OTHER,dissem=PU,lead=JU,issue=133, status=delivered]
  ...
  \begin{wpdeliv}[due=24,id=conv,dissem=PU,nature=DEC,lead=ZH,issue=138,status=canceled]
    {Conversion of existing and new Databases (\LMFDB, OEIS, \FindStat) to unified interoperable
      System}
    This deliverable has been merged into \localdelivref{psfoundation}.
  \end{wpdeliv}
  ...
  \begin{wpdeliv}[id=notebooksearch,due=30,nature=OTHER,dissem=PU,lead=FAU,issue=140,status=canceled]
    ...
    This deliverable has been merged into \localdelivref{nbad-search}
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,id=pssem,dissem=PU,nature=OTHER,lead=FAU,issue=141,status=canceled]
    ...
    This deliverable has been merged into \localdelivref{lfmverif}.
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,id=lfmverif,dissem=PU,nature=OTHER,lead=FAU,issue=142]
...
\begin{wpdeliv}[due=42,miles=WP6interop2,id=persistent-memoization,dissem=PU,nature=OTHER,lead=SA,issue=143]
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[id=nbad-search,due=42,nature=OTHER,dissem=PU,lead=FAU,issue=134]
  ...
  %  {Full-text search (Formulae + Keywords) in OpenDreamKit}
  % \end{wpdeliv}
  \begin{wpdeliv}[due=48,miles=eval,id=lfmint,dissem=PU,nature=R,lead=FAU,issue=135,status=canceled]
    {\LMFDB Integration of Algorithms, Data and Presentation}
    This deliverable was merged into \localdelivref{psfoundation} and \localdelivref{lmfverif}.
  \end{wpdeliv}
\end{wpdelivs}
