...
\end{tasklist}
  ...
  \begin{wpdelivs}
    ...
    \begin{wpdeliv}[due=24,miles=proto1,id=smc-trac,dissem=PU,nature=OTHER,lead=UV,issue=64,status=submitted]
    ...
    \begin{wpdeliv}[due=24,miles=proto1,id=portability-cygwin,dissem=PU,nature=OTHER,lead=PS,issue=66,status=submitted]
    ...
    \begin{wpdeliv}[due=36,miles=component-architecture-distribution,id=multiplatform-buildbot,dissem=PP,nature=DEM,lead=UV,issue=67,status=submitted]
