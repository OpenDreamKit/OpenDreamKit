...
\begin{workpackage}[id=component-architecture,wphases=0-48!.5,
  ...
  \begin{tasklist}
  \begin{task}[id=portability,title=Portability,lead=UV,PM=28,partners={PS,UG},wphases=0-36,issue=50]
  ...
  \begin{task}[title=Modularisation and packaging,id=mod-packaging,lead=UV,PM=20,partners={PS,LL,UG},wphases=0-48,issue=52]
...
\end{tasklist}
  ...
  \begin{wpdelivs}
    ...
    \begin{wpdeliv}[due=6,miles=startup,id=virtual-machines,dissem=PU,nature=OTHER,lead=UV,issue=58]
    ...
    \end{wpdeliv}
    \begin{wpdeliv}[due=18,miles=startup,id=smc-documentation,dissem=PU,nature=R,lead=PS,issue=61]
      {Understand and document \SMC backend code.}
    \end{wpdeliv}%

    \begin{wpdeliv}[due=12,miles=startup,id=scscp-sage,dissem=PU,nature=OTHER,lead=SA,issue=62]
