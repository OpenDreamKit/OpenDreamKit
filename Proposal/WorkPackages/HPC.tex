...
\end{wpdeliv}
  \begin{wpdeliv}[due=18,miles=startup,id=pythran-sage,dissem=PU,nature=DEM,lead=UJF]
...
%  \end{wpdeliv}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=12,miles=startup,id=pythran-typing,dissem=PU,nature=DEM, lead=LL]
...
\end{wpdeliv}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=48,miles=eval,id=GAP-HPC-report,dissem=PU,nature=R,lead=SA]
      {Final report and evaluation of all the \GAP developments.}
  \end{wpdeliv}
  \begin{wpdeliv}[due=48,id=pari-hpc2,dissem=PU,nature=DEM,lead=UB]
