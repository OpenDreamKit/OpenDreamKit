...
\end{wpdeliv}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,miles=hpc-prototype,id=sage-HPCcombi,dissem=PU,nature=DEM,lead=UB,issue=109,status=submitted]
...
%\end{wpdeliv}
  \begin{wpdeliv}[due=36,miles=hpc-prototype,id=LinBox-algo,dissem=PU,nature=DEM, lead=UJF,issue=110,status=submitted]
