...
,id=cfd-vis,lead=SR, partners={US,PS,USO},PM=5,wphases=12-36,issues=77]
...
\begin{task}[lead=UB,title=Common option system for various displays
  in Sage,id=Sage-display,PM=12,wphases=0-24issue=78]
...
\begin{task}[lead=UB,title=Python/Cython bindings for \Pari,PM=16,id=pari-python,partners={UB,UG},wphases=0-48issue=80]
