...
\begin{workpackage}[id=UI,wphases=0-48,
  ...
  USHRM=7.36, % Supporting reproducible data science and sharing of models
  ...
  LEEDS=1 %real PM for Leeds is 0.64
...
\begin{wpdelivs}
  ...
  \begin{wpdeliv}[due=36,id=vis3d,miles=UI-vre,dissem=PU,nature=OTHER,lead=SR,issue=86]
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,miles=UI-vre-prototype,id=jupyter-live-collab,dissem=PU,nature=OTHER,lead=SR,issue=89]
      {Exploratory support for live notebook collaboration}
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,id=ipython-advanced-interacts,miles=UI-vre-prototype,dissem=PU,nature=DEM,lead=PS,issue=90]
