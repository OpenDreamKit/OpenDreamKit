...
\begin{enumerate}
\item Addition of Friedrich Alexander University Erlangen/Nuremberg (\site{FAU}) to the list of beneficiaries\ednote{only site description really so far}
...
\item Changed the lead of \delivref{semantic-interface-sage-gap} from
  \site{UO} to \site{PS}.
  \item Change the lead of \site{SHU} from Neil Lawrence to Michael Croucher. 
\end{enumerate}
\clearpage
\setcounter{page}{1}
