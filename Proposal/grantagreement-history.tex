...
\item Integration of WP7 activities into other WPs:
  ...
  \item Canceled \taskref{social-aspects}{social-input} and moved PM to WP3
  \item Canceled \taskref{social-aspects}{social-output} and associated deliverables \delivref{social-aspects}{jupyter-comment} , \delivref{social-aspects}{social-poster} and \delivref{social-aspects}{social-publishing-report} and moved PM to \longtaskref{dissem}{IntroODK}
  \item Canceled \taskref{social-aspects}{isocial-decisionmaking} and moved PM to WP3 and WP5
  \end{itemize}
\item Miscellaneous
  \begin{itemize}
...
\item Work package specific milestones:
  \begin{itemize}
  \item Introduced two milestones for WP6 at months 36 and 42.
  \item Discussion in progress for the other work packages. \ednote{still need the others!}
  \end{itemize}
\end{enumerate}
