...
\item Integration of WP7 activities into other WPs:
 ...
 \item Integrated T7.4 in
  ...
  \end{itemize}
The addition of manpower to WP3 and WP5 will enable an extension of the scope of the tasks \longtaskref{component-architecture}{portability}, \longtaskref{component-architecture}{mod-packaging}, and \longtaskref{hpc}{pythran}. WP2 has proved to be very successful and \TheProject is gaining momentum. The addition of manpower to this WorkPackage will allow the consortium to answer the increasing number of demands for collaboration and our needs for dissemination.
...
\item Miscellaneous
  ...
  \item Termination of Jacobsuni on 09/01/2018: all relevant staff for the project was moved to FAU and Université Paris-Sud (originally planned on 31/12/2017 but was postponed to comply with the date of official submission of the amendment)
  \item Termination of UZH on 09/01/2018: all activity planned for the partner has been accomplished and resources were spent (originally planned on 31/12/2017 but was postponed comply with the date of official submission of the amendment)
  \end{itemize}
\end{enumerate}
