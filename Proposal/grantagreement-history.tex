...
\clearpage
\thispagestyle{empty}
\subsection*{2nd amendment of the Grant Agreement, ???? 2017}
...
\item Change the lead of \site{USH} from Neil Lawrence to Michael Croucher, and the breakdown 
...
\item \site{PS} changed its PhD position of 36 PM into a Postdoc position of 24 PM
  Reduced accordingly \site{PS}'s involvement in PM's in WP\WPref{dksbases}.
\item Consistency fix for \site{PS}: adjusted involvement in
  \WPref{CA} from 50~PM to 46~PM and reduced accordingly the PM's
