...
\item As suggested by the Project Officer,  formalization of budgets transfers between beneficiaries to optimize the significantly lower incurred eligible costs of LEEDS than its estimated eligible costs ( about 258k€: 133k€ of personnel Costs, and 73k€ of Other direct costs):

\begin{enumerate}
\item USlaski: Transfers between budget categories, 8k€ from Other direct costs and 2k€ from Personnel costs both to subcontracting costs to further develop K3D-jupyter (Tasks involed T4.8, T4.9);
...
\item UPSUD: transfer of 15k€ From Leeds budgets (Other direct costs) to UPSud Other direct costs budget category to support the dissemination activities organized during spring and summer 2019 (tasks involved: T2.2, T2.3, T2.5);
