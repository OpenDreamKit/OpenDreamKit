...
\WAinstitution[id=USH,
        countryshort=UK,
        acronym=USFD]
        {University of Sheffield-Terminated}

\WAinstitution[id=USO,
        countryshort=UK,
        acronym=SOUTHAMPTON]
        {University of Southampton-Terminated}
...
\WAinstitution[id=JU,
        countryshort=DE,
        acronym=JacobsUni]
        {Jacobs University Bremen-Terminated}
...
\WAinstitution[id=ZH,
        countryshort=CH,
        acronym=UZH]
        {Universit\"{a}t Z\"{u}rich-Terminated}
