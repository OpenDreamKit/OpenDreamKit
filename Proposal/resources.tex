...
To carry out the Isabelle case study (T6.11), we will subcontract Makarius Wenzel, the main 
...
There is currently no alternative way of conducting this case studies, since developing the necessary 
expertise in-house would take about 6-12PM and all other Isabelle developers have long-running contracts.
Furthermore, The Isabelle system is so complex that it is impossible for anybody but a few experts to 
...
the export. We will subcontract him 30,000 to write the export.
...
\begin{tabular}{|r|r|p{8.5cm}|}
  ...
  \textbf{Travel} & 47,400 & Travel (see the guidelines \ref{sect:budget-details-travel})\\\hline
...
\textbf{Total} & 75,095.55\\\cline{1-2}
\end{tabular}
